...
static constexpr const enum_value<
	EGLenum,
	mp_list<eglplus::context_flag>
> context_opengl_forward_compatible_bit = {EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT};
#endif
...
static constexpr const enum_value<
	EGLenum,
	mp_list<eglplus::context_attrib>
> context_opengl_reset_notification_strategy = {EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY};
#endif
