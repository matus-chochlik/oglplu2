...
static inline
void for_each_elem(const cstring_span& list, Func func)
noexcept {
	span_size_t i = 0;
	bool first = true;
	while(i < list.size()) {
...
template <typename Func>
static inline
void for_each(const cstring_span& list, Func func)
noexcept {
	auto adapted_func =
...
template <typename Func>
static inline
void rev_for_each_elem(const cstring_span& list, Func func)
noexcept {
...
template <typename Func>
static inline
void rev_for_each(const cstring_span& list, Func func)
noexcept {
	auto adapted_func =
	[&func](const element& elem, bool) {
		func(elem.value());
