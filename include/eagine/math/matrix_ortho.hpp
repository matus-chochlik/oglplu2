...
struct ortho<matrix<T,4,4,RM,V>>
{
	...
	constexpr inline T _x_left(void) const { return _v[0]; }
	constexpr inline T _x_right(void) const { return _v[1]; }
	constexpr inline T _y_bottom(void) const { return _v[2]; }
	constexpr inline T _y_top(void) const { return _v[3]; }
	constexpr inline T _z_near(void) const { return _v[4]; }
	constexpr inline T _z_far(void) const { return _v[5]; }
