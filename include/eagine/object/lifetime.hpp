 ...
 */
#ifndef EAGINE_OBJECT_LIFETIME_HPP
#define EAGINE_OBJECT_LIFETIME_HPP
...
struct obj_lifetime_ops {
    using gen_del_ops = typename object_traits<ObjTag>::gen_del_ops;
...
#endif // EAGINE_OBJECT_LIFETIME_HPP
