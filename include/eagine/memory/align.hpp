...
static constexpr inline span_size_t misalignment(
  span_size_t addr, span_size_t alignment) noexcept {
    return addr % alignment;
}
//------------------------------------------------------------------------------
static constexpr inline span_size_t misalignment(
  std::nullptr_t, span_size_t) noexcept {
    return 0;
}
//------------------------------------------------------------------------------
static constexpr inline bool is_aligned_to(
  span_size_t addr, span_size_t algn) noexcept {
...
static constexpr inline bool is_aligned_as(
  span_size_t addr, identity<T> = {}) noexcept {
