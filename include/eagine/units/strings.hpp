...
static inline cstr_ref
get_scale_name(Scale) noexcept {
    return mp_make_string<scale_name<Scale>>::value;
}

template <typename Scale>
static inline cstr_ref
get_scale_symbol(Scale) noexcept {
...
static inline cstr_ref
get_dim_name(bits::dims<H, T>) noexcept {
