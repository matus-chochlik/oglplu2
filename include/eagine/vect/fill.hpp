 ...
 */
#ifndef EAGINE_VECT_FILL_1509260923_HPP
#define EAGINE_VECT_FILL_1509260923_HPP
...
struct fill<T, 0, V> {
    static constexpr data_t<T, 0, V> apply(T) noexcept {
	return {};
    }
};
...
template <typename T, bool V>
struct fill<T, 8, V> {
    static constexpr data_t<T, 8, V> apply(T v) noexcept {
