...
public:
	...
	template <
		...
		typename = typename std::enable_if<
			mp_contains<Classes,Enum>::value
		>::type
	>
	constexpr inline
	...
	constexpr inline
	combined_enum_value(indexed_enum_base<value_type, base_value, lib_id>)
	noexcept
	 : _value(base_value)
	{ }

	constexpr inline
	combined_enum_value(indexed_enum_value<value_type, base_value, lib_id>v)
	noexcept
	 : _value(value_type(base_value+v._index))
	{ }

	explicit constexpr inline
	combined_enum_value(value_type value)
	noexcept
	 : _value(value)
	{ }
	...
	explicit
	operator IndexedEnum (void) const
	noexcept
	{
	...
	bool operator == (combined_enum_value a, combined_enum_value b)
	noexcept
	{
