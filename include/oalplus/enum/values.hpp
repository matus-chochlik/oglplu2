...
//
#ifndef OALPLUS_AL_ENUM_VALUES_HPP // NOLINT(llvm-header-guard)
...
struct enum_values {
    ...
    static constexpr const enum_value<ALenum, mp_list<oalplus::distance_model>>
...
#ifdef AL_EXTENSIONS
    static constexpr const enum_value<ALenum, mp_list<oalplus::string_query>>
      extensions = {AL_EXTENSIONS};
#endif

#ifdef AL_FORMAT_MONO16
    static constexpr const enum_value<ALenum, mp_list<oalplus::data_format>>
...
#ifdef AL_INITIAL
    static constexpr const enum_value<ALenum, mp_list<oalplus::source_state>>
      initial = {AL_INITIAL};
#endif

#ifdef AL_INVALID_ENUM
    static constexpr const enum_value<ALenum, mp_list<oalplus::al_error_code>>
...
#ifdef AL_STATIC
    static constexpr const enum_value<ALenum, mp_list<oalplus::source_type>>
      static_ = {AL_STATIC};
#endif
