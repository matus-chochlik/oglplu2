...
//
#ifndef OALPLUS_ALC_ENUM_VALUES_HPP // NOLINT(llvm-header-guard)
...
#ifdef ALC_FREQUENCY
    static constexpr const enum_value<ALCenum, mp_list<oalplus::context_attrib>>
      frequency = {ALC_FREQUENCY};
#endif

#ifdef ALC_INVALID_CONTEXT
    static constexpr const enum_value<ALCenum, mp_list<oalplus::alc_error_code>>
...
#endif // OALPLUS_ALC_ENUM_VALUES_HPP
