...
struct transform_feedback_ops {
    ...
    static outcome<void> get_transform_feedback_i64v(
      transform_feedback_name xfb,
      transform_feedback_parameter param,
      GLuint index,
    ...
    static outcome<GLint64> transform_feedback_buffer_size(
      transform_feedback_name xfb, GLuint index) noexcept;

    static outcome<void> transform_feedback_buffer_base(
      transform_feedback_name xfb, GLuint index, buffer_name buf) noexcept;

    static outcome<void> transform_feedback_buffer_range(
      transform_feedback_name xfb,
      GLuint index,
      buffer_name buf,
      GLintptr offset,
