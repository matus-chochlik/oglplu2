...
struct vertex_array_ops {
    ...
    static outcome<void> enable_vertex_array_attrib(
      vertex_array_name, vertex_attrib_location) noexcept;

    static outcome<void> disable_vertex_array_attrib(
      vertex_array_name, vertex_attrib_location) noexcept;
#endif

    static outcome<void> vertex_array_attrib_pointer(vertex_attrib_location loc,
    ...
    static outcome<void> vertex_array_attrib_i_pointer(
    ...
    static outcome<void> vertex_array_vertex_buffer(GLuint binding_index,
      buffer_name buf,
      buffer_size offset,
    ...
    static outcome<void> vertex_array_attrib_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLuint relative_offset) noexcept;

    static outcome<void> vertex_array_attrib_i_format(
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept;

    static outcome<void> vertex_array_attrib_l_format(
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept;
...
#if defined(GL_VERSION_4_5) || defined(GL_ARB_direct_state_access)
    static outcome<void> vertex_array_vertex_buffer(vertex_array_name vao,
      vertex_attrib_location loc,
      buffer_name buf,
      GLintptr offset,
    ...
    static outcome<void> vertex_array_attrib_binding(vertex_array_name vao,
      vertex_attrib_location loc,
    ...
    static outcome<void> vertex_array_attrib_format(vertex_array_name vao,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
    ...
    static outcome<void> vertex_array_attrib_i_format(vertex_array_name vao,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept;

    static outcome<void> vertex_array_attrib_l_format(vertex_array_name vao,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept;
    ...
    static outcome<void> vertex_array_attrib_offset(vertex_array_name vao,
      buffer_name buf,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
    ...
    static outcome<void> vertex_array_attrib_i_offset(vertex_array_name vao,
      buffer_name buf,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
    ...
    static outcome<void> buffer_address_range(unified_array_address_nv uba,
      GLuint index,
      buffer_address addr,
...
struct object_binding<tag::vertex_array> {
    ...
    outcome<object_binding&> attrib_pointer(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLsizei stride,
	...
	return {_ops::vertex_array_attrib_pointer(
		  loc, values_per_vertex, type, normalized, stride, pointer),
	  *this};
    }

    outcome<object_binding&> attrib_i_pointer(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLsizei stride,
      const void* pointer) noexcept {
	return {_ops::vertex_array_attrib_i_pointer(
		  loc, values_per_vertex, type, stride, pointer),
	  *this};
    }

#if defined(GL_VERSION_4_3) || defined(GL_ARB_vertex_attrib_binding)
    outcome<object_binding&> attrib_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_format(
		  loc, values_per_vertex, type, normalized, relative_offset),
	  *this};
    }

    outcome<object_binding&> attrib_i_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_i_format(
		  loc, values_per_vertex, type, relative_offset),
	  *this};
    }

    outcome<object_binding&> attrib_l_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
...
struct obj_dsa_ops<tag::vertex_array> : obj_zero_dsa_ops<tag::vertex_array> {
    ...
    outcome<obj_dsa_ops&> enable_attrib(vertex_attrib_location loc) noexcept {
	return {_ops::enable_vertex_array_attrib(*this, loc), *this};
    }

    outcome<obj_dsa_ops&> disable_attrib(vertex_attrib_location loc) noexcept {
	return {_ops::disable_vertex_array_attrib(*this, loc), *this};
    }

#if defined(GL_VERSION_4_5) || defined(GL_ARB_direct_state_access)
    outcome<obj_dsa_ops&> vertex_buffer(vertex_attrib_location loc,
      buffer_name buf,
      GLintptr offset,
      GLsizei stride) noexcept {
	return {
	  _ops::vertex_array_vertex_buffer(*this, loc, buf, offset, stride),
	  *this};
    }

    outcome<obj_dsa_ops&> attrib_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLuint relative_offset) noexcept {
	return {
	  _ops::vertex_array_attrib_format(
	    *this, loc, values_per_vertex, type, normalized, relative_offset),
	  *this};
    }

    outcome<obj_dsa_ops&> attrib_i_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_i_format(
		  *this, loc, values_per_vertex, type, relative_offset),
	  *this};
    }

    outcome<obj_dsa_ops&> attrib_l_format(vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_l_format(
...
#if defined(GL_EXT_direct_state_access)
    outcome<obj_dsa_ops&> attrib_offset(buffer_name buf,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLsizei stride,
      GLintptr offset) noexcept {
	return {_ops::vertex_array_attrib_offset(*this,
		  buf,
		  loc,
		  values_per_vertex,
		  type,
    ...
    outcome<obj_dsa_ops&> attrib_i_offset(buffer_name buf,
      vertex_attrib_location loc,
      GLint values_per_vertex,
      data_type type,
      GLsizei stride,
	...
	return {_ops::vertex_array_attrib_i_offset(
		  *this, buf, loc, values_per_vertex, type, stride, offset),
	  *this};
    }
#endif
...
public:
    ...
    outcome<vertex_array_attrib&> format(GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLuint relative_offset) noexcept {
	return {
	  _ops::vertex_array_attrib_format(
	    _vao, _loc, values_per_vertex, type, normalized, relative_offset),
	  *this};
    }

    outcome<vertex_array_attrib&> i_format(GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_i_format(
		  _vao, _loc, values_per_vertex, type, relative_offset),
	  *this};
    }

    outcome<vertex_array_attrib&> l_format(GLint values_per_vertex,
      data_type type,
      GLuint relative_offset) noexcept {
	return {_ops::vertex_array_attrib_l_format(
		  _vao, _loc, values_per_vertex, type, relative_offset),
...
#if defined(GL_EXT_direct_state_access)
    outcome<vertex_array_attrib&> offset(buffer_name buf,
      GLint values_per_vertex,
      data_type type,
      boolean normalized,
      GLsizei stride,
      GLintptr offset) noexcept {
	return {_ops::vertex_array_attrib_offset(_vao,
		  buf,
		  _loc,
		  values_per_vertex,
		  type,
    ...
    outcome<vertex_array_attrib&> i_offset(buffer_name buf,
      GLint values_per_vertex,
      data_type type,
      GLsizei stride,
      GLintptr offset) noexcept {
	return {_ops::vertex_array_attrib_i_offset(
		  _vao, buf, _loc, values_per_vertex, type, stride, offset),
	  *this};
    }
#endif
};
...
static const object_zero_and_ops<tag::vertex_array> no_vertex_array = {};
