...
struct stencil_func_args
{
	...
	compare_function func(void) const
	noexcept
	{
		return _func;
	}
...
struct stencil_operations
{
	...
	stencil_operation stencil_fail(void) const
	noexcept
	{
		return _sfail;
	}

	stencil_operation depth_fail(void) const
	noexcept
	{
		return _dfail;
	}

	stencil_operation depth_pass(void) const
	noexcept
	{
		return _dpass;
	}
...
struct stencil_test_state
{
	...
	static
	outcome<void>
	stencil_func(const stencil_func_args& fa)
	noexcept
	{
	...
	static
	outcome<void>
	stencil_func_separate(single_face face, const stencil_func_args& fa)
	noexcept
	{
	...
	static
	outcome<void>
	stencil_op(const stencil_operations & so)
	noexcept
	{
		return stencil_op(
			so.stencil_fail(),
	...
	static
	outcome<void>
	stencil_op_separate(single_face face, const stencil_operations & so)
	noexcept
	{
