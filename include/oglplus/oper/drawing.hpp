 ...
 */
#ifndef OGLPLUS_OPER_DRAWING_HPP
#define OGLPLUS_OPER_DRAWING_HPP
...
struct drawing_state {
    ...
    static outcome<void> primitive_restart_index(GLuint index) noexcept;
#endif
...
struct drawing_ops {
    ...
    static outcome<void> draw_arrays_instanced_base_instance(
      primitive_type mode,
      GLint first,
      GLsizei count,
      GLsizei primcount,
    ...
    static outcome<void> draw_elements_instanced_base_vertex(
      primitive_type mode,
      GLsizei count,
      index_type type,
      const GLvoid* indices,
...
#if defined(GL_VERSION_4_2)
    static outcome<void> draw_elements_instanced_base_instance(
      primitive_type mode,
      GLsizei count,
      index_type type,
      const GLvoid* indices,
    ...
    static outcome<void> draw_elements_instanced_base_vertex_base_instance(
      primitive_type mode,
      GLsizei count,
      index_type type,
      const GLvoid* indices,
...
#if defined(GL_VERSION_4_0)
    static outcome<void> draw_elements_indirect(
      primitive_type mode, index_type type, const GLvoid* indirect) noexcept;

    static outcome<void> draw_transform_feedback(
      primitive_type mode, transform_feedback_name xfb) noexcept;

    static outcome<void> draw_transform_feedback_stream(
    ...
    static outcome<void> draw_transform_feedback_stream_instanced(
      primitive_type mode,
      transform_feedback_name xfb,
      GLuint stream,
      GLsizei primcount) noexcept;
...
#endif // OGLPLUS_OPER_DRAWING_HPP
