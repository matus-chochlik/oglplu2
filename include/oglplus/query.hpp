 ...
 */
#ifndef OGLPLUS_QUERY_HPP
#define OGLPLUS_QUERY_HPP
...
struct query_ops {
    ...
    static outcome<boolean> query_result_available(query_name qry) noexcept;

#if defined(GL_VERSION_3_0)
    static outcome<void> query_result(query_name qry, GLint& result) noexcept;

    static outcome<void> query_result(query_name qry, GLuint& result) noexcept;
#endif
