...
struct polygon_mode
 : enum_class<polygon_mode, GLenum, 74>
{ using enum_class::enum_class; };

struct precision_type
 : enum_class<precision_type, GLenum, 75>
{ using enum_class::enum_class; };

struct primitive_type
 : enum_class<primitive_type, GLenum, 76>
{ using enum_class::enum_class; };

struct program_interface
 : enum_class<program_interface, GLenum, 77>
{ using enum_class::enum_class; };

struct program_parameter
 : enum_class<program_parameter, GLenum, 78>
{ using enum_class::enum_class; };

struct program_pipeline_parameter
 : enum_class<program_pipeline_parameter, GLenum, 79>
{ using enum_class::enum_class; };

struct program_pipeline_stage
 : enum_class<program_pipeline_stage, GLbitfield, 80>
{ using enum_class::enum_class; };

struct program_resource_property
 : enum_class<program_resource_property, GLenum, 81>
{ using enum_class::enum_class; };

struct provoke_mode
 : enum_class<provoke_mode, GLenum, 82>
{ using enum_class::enum_class; };

struct query_parameter
 : enum_class<query_parameter, GLenum, 83>
{ using enum_class::enum_class; };

struct query_target
 : enum_class<query_target, GLenum, 84>
{ using enum_class::enum_class; };

struct renderbuffer_parameter
 : enum_class<renderbuffer_parameter, GLenum, 85>
{ using enum_class::enum_class; };

struct renderbuffer_target
 : enum_class<renderbuffer_target, GLenum, 86>
{ using enum_class::enum_class; };

struct reset_notification_strategy
 : enum_class<reset_notification_strategy, GLenum, 87>
{ using enum_class::enum_class; };

struct sampler_parameter
 : enum_class<sampler_parameter, GLenum, 88>
{ using enum_class::enum_class; };

struct shader_parameter
 : enum_class<shader_parameter, GLenum, 89>
{ using enum_class::enum_class; };

struct shader_type
 : enum_class<shader_type, GLenum, 90>
{ using enum_class::enum_class; };

struct single_face
 : enum_class<single_face, GLenum, 91>
{ using enum_class::enum_class; };

struct sl_data_type
 : enum_class<sl_data_type, GLenum, 92>
{ using enum_class::enum_class; };

struct stencil_operation
 : enum_class<stencil_operation, GLenum, 93>
{ using enum_class::enum_class; };

struct string_query
 : enum_class<string_query, GLenum, 94>
{ using enum_class::enum_class; };

struct sync_condition
 : enum_class<sync_condition, GLenum, 95>
{ using enum_class::enum_class; };

struct sync_status
 : enum_class<sync_status, GLenum, 96>
{ using enum_class::enum_class; };

struct sync_type
 : enum_class<sync_type, GLenum, 97>
{ using enum_class::enum_class; };

struct sync_wait_result
 : enum_class<sync_wait_result, GLenum, 98>
{ using enum_class::enum_class; };

struct tess_gen_primitive_spacing
 : enum_class<tess_gen_primitive_spacing, GLenum, 99>
{ using enum_class::enum_class; };

struct tess_gen_primitive_type
 : enum_class<tess_gen_primitive_type, GLenum, 100>
{ using enum_class::enum_class; };

struct texture_compare_mode
 : enum_class<texture_compare_mode, GLenum, 101>
{ using enum_class::enum_class; };

struct texture_filter
 : enum_class<texture_filter, GLenum, 102>
{ using enum_class::enum_class; };

struct texture_mag_filter
 : enum_class<texture_mag_filter, GLenum, 103>
{ using enum_class::enum_class; };

struct texture_min_filter
 : enum_class<texture_min_filter, GLenum, 104>
{ using enum_class::enum_class; };

struct texture_parameter
 : enum_class<texture_parameter, GLenum, 105>
{ using enum_class::enum_class; };

struct texture_swizzle_coord
 : enum_class<texture_swizzle_coord, GLenum, 106>
{ using enum_class::enum_class; };

struct texture_swizzle_mode
 : enum_class<texture_swizzle_mode, GLenum, 107>
{ using enum_class::enum_class; };

struct texture_target
 : enum_class<texture_target, GLenum, 108>
{ using enum_class::enum_class; };

struct texture_wrap_coord
 : enum_class<texture_wrap_coord, GLenum, 109>
{ using enum_class::enum_class; };

struct texture_wrap_mode
 : enum_class<texture_wrap_mode, GLenum, 110>
{ using enum_class::enum_class; };

struct transform_feedback_mode
 : enum_class<transform_feedback_mode, GLenum, 111>
{ using enum_class::enum_class; };

struct transform_feedback_parameter
 : enum_class<transform_feedback_parameter, GLenum, 112>
{ using enum_class::enum_class; };

struct transform_feedback_primitive_type
 : enum_class<transform_feedback_primitive_type, GLenum, 113>
{ using enum_class::enum_class; };

struct transform_feedback_target
 : enum_class<transform_feedback_target, GLenum, 114>
{ using enum_class::enum_class; };

struct true_false
 : enum_class<true_false, GLboolean, 115>
{ using enum_class::enum_class; };

struct unified_array_address_nv
 : enum_class<unified_array_address_nv, GLenum, 116>
{ using enum_class::enum_class; };
