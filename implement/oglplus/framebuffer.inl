...
inline outcome<void>
framebuffer_ops::framebuffer_parameter_i(framebuffer_target fb_target,
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::framebuffer_renderbuffer(framebuffer_target fb_target,
...
#if defined(GL_VERSION_4_5) || defined(GL_EXT_direct_state_access)
inline outcome<void>
framebuffer_ops::framebuffer_renderbuffer(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  renderbuffer_target rb_target,
  renderbuffer_name rbo) noexcept {
#ifdef GL_VERSION_4_5
    ...
    (
      ...
      GLenum(rb_target),
      get_raw_name(rbo));
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferRenderbuffer),
      gl_object(fbo).
...
inline outcome<void>
framebuffer_ops::framebuffer_texture_1d(framebuffer_target fb_target,
  framebuffer_attachment fb_attach,
...
inline outcome<void>
framebuffer_ops::framebuffer_texture_1d(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  texture_target tx_target,
  texture_name tex,
  GLint level) noexcept {
    ...
    (get_raw_name(fbo),
      ...
      get_raw_name(tex),
      level);
    OGLPLUS_VERIFY(NamedFramebufferTexture1DEXT,
      gl_object(fbo).
      // gl_enum_value(fb_target).
      gl_subject(tex),
      debug);
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::framebuffer_texture_2d(framebuffer_target fb_target,
  framebuffer_attachment fb_attach,
  texture_target tx_target,
  texture_name tex,
  GLint level) noexcept {
...
#if defined(GL_EXT_direct_state_access)
inline outcome<void>
framebuffer_ops::framebuffer_texture_2d(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  texture_target tx_target,
  texture_name tex,
  GLint level) noexcept {
    ...
    (get_raw_name(fbo),
      ...
      get_raw_name(tex),
      level);
    OGLPLUS_VERIFY(NamedFramebufferTexture2DEXT,
      gl_object(fbo).
      // gl_enum_value(fb_target).
      gl_subject(tex),
      debug);
...
#if defined(GL_VERSION_3_0)
inline outcome<void>
framebuffer_ops::framebuffer_texture_3d(framebuffer_target fb_target,
  framebuffer_attachment fb_attach,
  texture_target tx_target,
  texture_name tex,
  GLint level,
...
#if defined(GL_EXT_direct_state_access)
inline outcome<void>
framebuffer_ops::framebuffer_texture_3d(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  texture_target tx_target,
  texture_name tex,
  GLint level,
  GLint layer) noexcept {
    ...
    (get_raw_name(fbo),
      ...
      level,
      layer);
    OGLPLUS_VERIFY(NamedFramebufferTexture3DEXT,
      gl_object(fbo).
      // gl_enum_value(fb_target).
      gl_subject(tex),
      debug);
...
#if defined(GL_VERSION_3_0)
inline outcome<void>
framebuffer_ops::framebuffer_texture_layer(framebuffer_target fb_target,
  framebuffer_attachment fb_attach,
  texture_name tex,
  GLint level,
  GLint layer) noexcept {
...
inline outcome<void>
framebuffer_ops::framebuffer_texture_layer(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  texture_name tex,
  GLint level,
  GLint layer) noexcept {
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferTextureLayer),
      gl_object(fbo).
      // gl_enum_value(fb_target).
      gl_subject(tex),
      debug);
...
inline outcome<void>
framebuffer_ops::framebuffer_texture(framebuffer_target fb_target,
  framebuffer_attachment fb_attach,
  texture_name tex,
  GLint level) noexcept {
...
#if defined(GL_VERSION_4_5) || defined(GL_EXT_direct_state_access)
inline outcome<void>
framebuffer_ops::framebuffer_texture(framebuffer_name fbo,
  framebuffer_attachment fb_attach,
  texture_name tex,
  GLint level) noexcept {
#ifdef GL_VERSION_4_5
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferTexture),
      gl_object(fbo).
      // gl_enum_value(fb_target).
      gl_subject(tex),
      debug);
...
framebuffer_ops::framebuffer_draw_buffer(
  framebuffer_name fbo, framebuffer_color_attachment buf) noexcept {
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferDrawBuffer),
...
framebuffer_ops::framebuffer_draw_buffers(
  framebuffer_name fbo, enum_span<framebuffer_attachment> bufs) noexcept {
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferDrawBuffers),
      gl_object(fbo),
      debug);
    return {};
}
...
#endif
      get_raw_name(fbo), GLenum(buf));
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferReadBuffer),
      gl_object(fbo).gl_enum_value(buf),
      debug);
    return {};
}
...
#if defined(GL_VERSION_3_0)
inline outcome<void>
framebuffer_ops::clear_buffer(framebuffer_buffer buf,
  GLint draw_buffer,
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::blit_framebuffer(GLint srcX0,
  GLint srcY0,
  GLint srcX1,
  GLint srcY1,
  GLint dstX0,
...
#if defined(GL_VERSION_4_3)
inline outcome<void>
framebuffer_ops::invalidate_framebuffer_data(framebuffer_target tgt,
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::invalidate_framebuffer_sub_data(framebuffer_target tgt,
...
#if defined(GL_VERSION_4_5)
inline outcome<void>
framebuffer_ops::clear_framebuffer(framebuffer_name fbo,
  framebuffer_buffer buf,
  GLint draw_buffer,
  span<const GLint> values) noexcept {
    OGLPLUS_GLFUNC(ClearNamedFramebufferiv)
    (get_raw_name(fbo), GLenum(buf), draw_buffer, values.data());
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferReadBufferiv),
...
framebuffer_ops::clear_framebuffer(framebuffer_name fbo,
  ...
  span<const GLuint> values) noexcept {
    ...
    (get_raw_name(fbo), GLenum(buf), draw_buffer, values.data());
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferReadBufferuiv),
      gl_object(fbo).gl_enum_value(buf).gl_index(draw_buffer),
      debug);
    return {};
}
...
framebuffer_ops::clear_framebuffer(framebuffer_name fbo,
  ...
  span<const GLfloat> values) noexcept {
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferReadBufferfv),
      gl_object(fbo).gl_enum_value(buf).gl_index(draw_buffer),
      debug);
    return {};
}
...
framebuffer_ops::clear_framebuffer(framebuffer_name fbo,
  ...
  GLint stencil) noexcept {
    ...
    OGLPLUS_VERIFY_STR(OGLPLUS_GL_DSA_FUNC_NAME(NamedFramebufferReadBufferfi),
      gl_object(fbo).gl_enum_value(buf).gl_index(draw_buffer),
      debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::invalidate_framebuffer_data(framebuffer_name fbo,
  enum_span<framebuffer_attachment> attachments) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::invalidate_framebuffer_sub_data(framebuffer_name fbo,
  enum_span<framebuffer_attachment> attachments,
  GLint x,
  GLint y,
  GLint width,
...
//------------------------------------------------------------------------------
inline outcome<void>
framebuffer_ops::blit_framebuffer(framebuffer_name srcfbo,
  ...
  blit_filter filter) noexcept {
    ...
    (get_raw_name(srcfbo),
      ...
      GLbitfield(mask),
      GLenum(filter));
    OGLPLUS_VERIFY(BlitNamedFramebuffer,
