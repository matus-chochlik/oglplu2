...
//------------------------------------------------------------------------------
inline outcome<void>
sampler_ops::bind_sampler(texture_unit unit, sampler_name sam) noexcept {
...
#endif
//------------------------------------------------------------------------------
inline outcome<sampler_name>
sampler_ops::sampler_binding(texture_unit unit) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<texture_min_filter>
sampler_ops::get_sampler_min_filter(sampler_name sam) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<texture_mag_filter>
sampler_ops::get_sampler_mag_filter(sampler_name sam) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<texture_compare_mode>
sampler_ops::get_sampler_compare_mode(sampler_name sam) noexcept {
...
sampler_ops::get_sampler_compare_func(sampler_name sam) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<texture_wrap_mode>
sampler_ops::get_sampler_wrap_s(sampler_name sam) noexcept {
    return return_sampler_parameter_i<texture_wrap_mode, GLenum>(
...
//------------------------------------------------------------------------------
inline outcome<texture_wrap_mode>
sampler_ops::get_sampler_wrap_t(sampler_name sam) noexcept {
    return return_sampler_parameter_i<texture_wrap_mode, GLenum>(
...
//------------------------------------------------------------------------------
inline outcome<texture_wrap_mode>
sampler_ops::get_sampler_wrap_r(sampler_name sam) noexcept {
    return return_sampler_parameter_i<texture_wrap_mode, GLenum>(
...
inline outcome<void>
sampler_ops::sampler_lod_bias(sampler_name sam, GLfloat value) noexcept {
...
sampler_ops::get_sampler_lod_bias(sampler_name sam) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<void>
sampler_ops::sampler_min_lod(sampler_name sam, GLfloat value) noexcept {
    return sampler_parameter_f(
...
//------------------------------------------------------------------------------
inline outcome<GLfloat>
sampler_ops::get_sampler_min_lod(sampler_name sam) noexcept {
    return return_sampler_parameter_f<GLfloat>(
...
//------------------------------------------------------------------------------
inline outcome<void>
sampler_ops::sampler_max_lod(sampler_name sam, GLfloat value) noexcept {
    return sampler_parameter_f(
...
//------------------------------------------------------------------------------
inline outcome<GLfloat>
sampler_ops::get_sampler_max_lod(sampler_name sam) noexcept {
    return return_sampler_parameter_f<GLfloat>(
...
obj_gen_del_ops<tag::sampler>::_gen(span<GLuint> names) noexcept {
...
inline deferred_error_handler
obj_gen_del_ops<tag::sampler>::_create(span<GLuint> names) noexcept {
...
//------------------------------------------------------------------------------
inline deferred_error_handler
obj_gen_del_ops<tag::sampler>::_delete(span<GLuint> names) noexcept {
...
obj_gen_del_ops<tag::sampler>::_is_a(GLuint name) noexcept {
