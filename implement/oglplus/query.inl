...
namespace oper {
//------------------------------------------------------------------------------
inline outcome<void> query_ops::begin_query(
...
//------------------------------------------------------------------------------
inline outcome<void> query_ops::end_query_indexed(
...
inline outcome<void> query_ops::query_counter(
...
//------------------------------------------------------------------------------
#if defined(GL_VERSION_3_0)
inline outcome<void> query_ops::query_result(
  query_name qry, GLint& result) noexcept {
    return get_query_object_iv(
...
#if defined(GL_VERSION_3_0)
inline outcome<void> query_ops::query_result(
  query_name qry, GLuint& result) noexcept {
...
#if defined(GL_VERSION_3_3) || defined(GL_ARB_timer_query)
inline outcome<void> query_ops::query_result(
  query_name qry, GLint64& result) noexcept {
...
//------------------------------------------------------------------------------
inline deferred_error_handler obj_gen_del_ops<tag::query>::_gen(
...
//------------------------------------------------------------------------------
inline deferred_error_handler obj_gen_del_ops<tag::query>::_delete(
  span<GLuint> names) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<boolean> obj_gen_del_ops<tag::query>::_is_a(
