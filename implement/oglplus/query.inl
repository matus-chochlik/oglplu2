...
//------------------------------------------------------------------------------
inline outcome<void>
query_ops::begin_query(query_target target, query_name qry) noexcept {
    OGLPLUS_GLFUNC(BeginQuery)(GLenum(target), get_raw_name(qry));
    OGLPLUS_VERIFY(BeginQuery, gl_enum_value(target).gl_object(qry), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
...
//------------------------------------------------------------------------------
inline outcome<void>
query_ops::end_query_indexed(query_target target, GLuint index) noexcept {
    OGLPLUS_GLFUNC(EndQueryIndexed)(GLenum(target), index);
    OGLPLUS_VERIFY(
      EndQueryIndexed, gl_enum_value(target).gl_index(index), debug);
    return {};
}
#endif
//------------------------------------------------------------------------------
...
query_ops::begin_conditional_render(
  query_name qry, conditional_render_mode mode) noexcept {
    ...
    OGLPLUS_VERIFY(
      BeginConditionalRender, gl_object(qry).gl_enum_value(mode), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
...
inline outcome<void>
query_ops::query_counter(query_name qry, query_target target) noexcept {
    OGLPLUS_GLFUNC(QueryCounter)(get_raw_name(qry), GLenum(target));
    OGLPLUS_VERIFY(QueryCounter, gl_object(qry).gl_enum_value(target), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
...
query_ops::get_query_object_iv(
  query_name qry, oglplus::query_parameter param, span<GLint> values) noexcept {
    ...
    (get_raw_name(qry), GLenum(param), values.data());
    OGLPLUS_VERIFY(
      GetQueryObjectiv, gl_object(qry).gl_enum_value(param), always);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
query_ops::get_query_object_uiv(
  ...
  span<GLuint> values) noexcept {
    ...
    (get_raw_name(qry), GLenum(param), values.data());
    OGLPLUS_VERIFY(
      GetQueryObjectuiv, gl_object(qry).gl_enum_value(param), always);
    return {};
}
#endif
//------------------------------------------------------------------------------
...
query_ops::get_query_object_i64v(
  ...
  span<GLint64> values) noexcept {
    ...
    (get_raw_name(qry), GLenum(param), values.data());
    OGLPLUS_VERIFY(
      GetQueryObjecti64v, gl_object(qry).gl_enum_value(param), always);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
query_ops::get_query_object_ui64v(
  ...
  span<GLuint64> values) noexcept {
    ...
    (get_raw_name(qry), GLenum(param), values.data());
    OGLPLUS_VERIFY(
      GetQueryObjectui64v, gl_object(qry).gl_enum_value(param), always);
    return {};
}
#endif
//------------------------------------------------------------------------------
...
#if defined(GL_VERSION_3_0)
inline outcome<void>
query_ops::query_result(query_name qry, GLint& result) noexcept {
    return get_query_object_iv(
      qry, query_parameter(GL_QUERY_RESULT), {&result, 1});
}
#endif
//------------------------------------------------------------------------------
#if defined(GL_VERSION_3_0)
inline outcome<void>
query_ops::query_result(query_name qry, GLuint& result) noexcept {
...
#if defined(GL_VERSION_3_3) || defined(GL_ARB_timer_query)
inline outcome<void>
query_ops::query_result(query_name qry, GLint64& result) noexcept {
    return get_query_object_i64v(
      qry, query_parameter(GL_QUERY_RESULT), {&result, 1});
}
//------------------------------------------------------------------------------
inline outcome<void>
query_ops::query_result(query_name qry, GLuint64& result) noexcept {
...
obj_gen_del_ops<tag::query>::_gen(span<GLuint> names) noexcept {
    OGLPLUS_GLFUNC(GenQueries)(GLsizei(names.size()), names.data());
...
//------------------------------------------------------------------------------
inline deferred_error_handler
obj_gen_del_ops<tag::query>::_delete(span<GLuint> names) noexcept {
    OGLPLUS_GLFUNC(DeleteQueries)(GLsizei(names.size()), names.data());
...
//------------------------------------------------------------------------------
inline outcome<boolean>
obj_gen_del_ops<tag::query>::_is_a(GLuint name) noexcept {
