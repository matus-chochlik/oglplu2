...
//------------------------------------------------------------------------------
inline outcome<void>
numeric_queries::get_integer_v(binding_query query, span<GLint> data) noexcept {
    assert(data.size() > 0);
...
numeric_queries::get_boolean(numeric_query query) noexcept {
    GLboolean result = 0;
    return get_boolean_v(query, {&result, 1}).add(boolean(result));
}
//------------------------------------------------------------------------------
inline outcome<void>
numeric_queries::get_integer_v(numeric_query query, span<GLint> data) noexcept {
    assert(data.size() > 0);
    OGLPLUS_GLFUNC(GetIntegerv)(GLenum(query), data.data());
    OGLPLUS_VERIFY(GetIntegerv, gl_enum_value(query), always);
    return {};
...
numeric_queries::get_integer(numeric_query query) noexcept {
    GLint result = 0;
...
numeric_queries::get_integer64(numeric_query query) noexcept {
    GLint64 result = 0;
...
//------------------------------------------------------------------------------
inline outcome<void>
numeric_queries::get_float_v(numeric_query query, span<GLfloat> data) noexcept {
    assert(data.size() > 0);
...
numeric_queries::get_float(numeric_query query) noexcept {
    GLfloat result = 0;
...
//------------------------------------------------------------------------------
inline outcome<GLdouble>
numeric_queries::get_double(numeric_query query) noexcept {
    GLdouble result = 0;
...
//------------------------------------------------------------------------------
inline outcome<boolean>
numeric_queries::get_boolean(numeric_query query, GLuint index) noexcept {
    GLboolean result = 0;
...
//------------------------------------------------------------------------------
inline outcome<GLint>
numeric_queries::get_integer(numeric_query query, GLuint index) noexcept {
    GLint result = 0;
...
//------------------------------------------------------------------------------
inline outcome<GLint64>
numeric_queries::get_integer64(numeric_query query, GLuint index) noexcept {
    GLint64 result = 0;
...
//------------------------------------------------------------------------------
inline outcome<GLfloat>
numeric_queries::get_float(numeric_query query, GLuint index) noexcept {
    GLfloat result = 0;
...
//------------------------------------------------------------------------------
inline outcome<GLdouble>
numeric_queries::get_double(numeric_query query, GLuint index) noexcept {
    GLdouble result = 0;
