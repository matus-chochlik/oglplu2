...
//------------------------------------------------------------------------------
inline outcome<void>
capability_state::enable(capability cap) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<void>
capability_state::disable(capability cap) noexcept {
...
capability_state::is_enabled(capability cap) noexcept {
...
inline outcome<void>
capability_state::enable(clip_plane cap) noexcept {
    OGLPLUS_GLFUNC(Enable)(GLenum(cap));
    OGLPLUS_VERIFY(Enable, gl_enum_value(cap), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
capability_state::disable(clip_plane cap) noexcept {
    OGLPLUS_GLFUNC(Disable)(GLenum(cap));
    OGLPLUS_VERIFY(Disable, gl_enum_value(cap), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<boolean>
capability_state::is_enabled(clip_plane cap) noexcept {
    GLboolean result = OGLPLUS_GLFUNC(IsEnabled)(GLenum(cap));
    OGLPLUS_VERIFY(IsEnabled, gl_enum_value(cap), always);
    return {boolean(result)};
}
