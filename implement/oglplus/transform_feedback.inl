...
transform_feedback_ops::bind_transform_feedback(
  transform_feedback_target target, transform_feedback_name xfb) noexcept {
    ...
    OGLPLUS_VERIFY(
      BindTransformFeedback, gl_enum_value(target).gl_object(xfb), debug);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<transform_feedback_name>
transform_feedback_ops::transform_feedback_binding(
...
//------------------------------------------------------------------------------
inline outcome<void>
transform_feedback_ops::end_transform_feedback(void) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<void>
transform_feedback_ops::pause_transform_feedback(void) noexcept {
...
//------------------------------------------------------------------------------
inline outcome<void>
transform_feedback_ops::resume_transform_feedback(void) noexcept {
...
transform_feedback_ops::get_transform_feedback_iv(
  ...
  span<GLint> values) noexcept {
    ...
    OGLPLUS_VERIFY(
      GetTransformFeedbackiv, gl_object(xfb).gl_enum_value(param), always);
    return {};
}
//------------------------------------------------------------------------------
inline outcome<void>
