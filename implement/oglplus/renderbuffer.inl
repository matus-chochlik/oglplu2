...
inline outcome<void> renderbuffer_ops::bind_renderbuffer(
  renderbuffer_target target, renderbuffer_name rbo) noexcept {
    ...
    OGLPLUS_VERIFY(
      BindRenderbuffer, gl_enum_value(target).gl_object(rbo), debug);
    return {};
}
//------------------------------------------------------------------------------
...
inline outcome<void> renderbuffer_ops::renderbuffer_storage_multisample(
  ...
  GLsizei height) noexcept {
    ...
    (
#endif
      get_raw_name(rbo), samples, GLenum(ifmt), width, height);
    OGLPLUS_VERIFY_STR(
...
//------------------------------------------------------------------------------
template <typename RNT>
inline outcome<pixel_data_internal_format>
renderbuffer_ops::get_renderbuffer_internal_format(const RNT& rnt) noexcept {
    return return_renderbuffer_parameter_i<pixel_data_internal_format, GLenum>(
      rnt, renderbuffer_parameter(GL_RENDERBUFFER_INTERNAL_FORMAT));
}
//------------------------------------------------------------------------------
} // namespace oper
//------------------------------------------------------------------------------
