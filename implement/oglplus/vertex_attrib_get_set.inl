...
struct prog_var_get_set_ops<tag::vertex_attrib, GLbyte> {
	...
	set(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4bv, debug); }
		return {};
	}
	...
	setI(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribI4bv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Nbv, debug); }
		return {};
	}
};
...
struct prog_var_get_set_ops<tag::vertex_attrib, GLubyte> {
	...
	set(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4ubv, debug); }
		return {};
	}
	...
	setI(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribI4ubv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Nubv, debug); }
		return {};
	}
};
...
struct prog_var_get_set_ops<tag::vertex_attrib, GLshort> {
	...
	setI(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribI4sv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Nsv, debug); }
		return {};
	}
};
template <>
struct prog_var_get_set_ops<tag::vertex_attrib, GLushort> {
	...
	set(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4usv, debug); }
		return {};
	}
	...
	setI(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribI4usv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Nusv, debug); }
		return {};
	}
};
...
struct prog_var_get_set_ops<tag::vertex_attrib, GLint> {
	...
	set(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4iv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Niv, debug); }
		return {};
	}
};
template <>
struct prog_var_get_set_ops<tag::vertex_attrib, GLuint> {
	...
	set(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4uiv, debug); }
		return {};
	}
	...
	setN(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttrib4Nuiv, debug); }
		return {};
	}
	...
	setP1(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribP1ui, debug); }
		return {};
	}
	...
	setP2(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribP2ui, debug); }
		return {};
	}
	...
	setP3(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribP3ui, debug); }
		return {};
	}
	...
	setP4(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribP4ui, debug); }
		return {};
	}
};
#if defined(GL_VERSION_3_0)
...
struct prog_var_get_set_ops<tag::vertex_attrib, GLdouble> {
	...
	setL(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribL1dv, debug); }
		return {};
	}
	...
	setL(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribL2dv, debug); }
		return {};
	}
	...
	setL(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribL3dv, debug); }
		return {};
	}
	...
	setL(
		...
		if(ge) { OGLPLUS_VERIFY_SIMPLE(VertexAttribL4dv, debug); }
		return {};
	}
