...
struct prog_var_get_set_ops<tag::uniform, GLint> {
    ...
    static outcome<void> set(
      ...
      span<const GLint> v) noexcept {
        ...
        EAGINE_ASSERT(v.size() >= span_size_t(1 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLint> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(2 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLint> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(3 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLint> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(4 * count));
...
struct prog_var_get_set_ops<tag::uniform, GLfloat> {
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(2 * 2 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(2 * 3 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(2 * 4 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(3 * 2 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(3 * 3 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(3 * 4 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(4 * 2 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(4 * 3 * count));
    ...
    static outcome<void> set(
      ...
      span<const GLfloat> v) noexcept {
        EAGINE_ASSERT(count >= 0);
        EAGINE_ASSERT(v.size() >= span_size_t(4 * 4 * count));
