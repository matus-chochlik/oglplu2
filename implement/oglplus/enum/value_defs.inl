...
constexpr const enum_value<GLenum, mp_list<oglplus::path_list_mode_nv>>
  enum_values::accum_adjacent_pairs_nv;
#endif

#ifdef GL_ACTIVE_ATOMIC_COUNTER_BUFFERS
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::active_atomic_counter_buffers;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_pipeline_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_resource_property>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::path_transform_type_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::numeric_query>>
  enum_values::aliased_line_width_range;
#endif

#ifdef GL_ALL_BARRIER_BITS
constexpr const enum_value<GLbitfield, mp_list<oglplus::memory_barrier_bits>>
  enum_values::all_barrier_bits;
#endif

#ifdef GL_ALL_SHADER_BITS
constexpr const enum_value<GLbitfield, mp_list<oglplus::program_pipeline_stage>>
  enum_values::all_shader_bits;
#endif

#ifdef GL_ALPHA
constexpr const enum_value<GLenum,
  mp_list<oglplus::path_color_format_nv, oglplus::texture_swizzle_mode>>
  enum_values::alpha;
#endif

#ifdef GL_ALPHA_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::alpha_bias;
#endif

#ifdef GL_ALPHA_REF_COMMAND_NV
constexpr const enum_value<GLenum, mp_list<oglplus::command_token_nv>>
  enum_values::alpha_ref_command_nv;
#endif

#ifdef GL_ALPHA_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::alpha_scale;
#endif

#ifdef GL_ALREADY_SIGNALED
constexpr const enum_value<GLenum, mp_list<oglplus::sync_wait_result>>
  enum_values::already_signaled;
#endif

#ifdef GL_ALWAYS
constexpr const enum_value<GLenum, mp_list<oglplus::compare_function>>
  enum_values::always;
#endif

#ifdef GL_AND
constexpr const enum_value<GLenum, mp_list<oglplus::color_logic_operation>>
  enum_values::and_;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::query_target>>
...
#ifdef GL_ARC_TO_NV
constexpr const enum_value<GLubyte, mp_list<oglplus::path_command_nv>>
  enum_values::arc_to_nv;
#endif

#ifdef GL_ARRAY_BUFFER
constexpr const enum_value<GLenum, mp_list<oglplus::buffer_target>>
  enum_values::array_buffer;
#endif

#ifdef GL_ARRAY_BUFFER_BINDING
constexpr const enum_value<GLenum, mp_list<oglplus::binding_query>>
...
constexpr const enum_value<GLenum,
  mp_list<oglplus::buffer_indexed_target,
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::auto_generate_mipmap;
#endif
...
#ifdef GL_BACK_LEFT
constexpr const enum_value<GLenum, mp_list<oglplus::color_buffer>>
...
#ifdef GL_BEVEL_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_join_style_nv>>
  enum_values::bevel_nv;
#endif

#ifdef GL_BGR
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_data_format>>
  enum_values::bgr;
#endif
...
#ifdef GL_BLUE_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::blue_scale;
#endif

#ifdef GL_BOLD_BIT_NV
constexpr const enum_value<GLbitfield, mp_list<oglplus::path_font_style_nv>>
  enum_values::bold_bit_nv;
#endif

#ifdef GL_BOOL
constexpr const enum_value<GLenum, mp_list<oglplus::sl_data_type>>
  enum_values::bool_;
#endif
...
#ifdef GL_BUFFER
constexpr const enum_value<GLenum, mp_list<oglplus::object_type>>
  enum_values::buffer;
#endif

#ifdef GL_BUFFER_ACCESS
constexpr const enum_value<GLenum, mp_list<oglplus::buffer_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_interface>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::support_level>>
  enum_values::caveat_support;
#endif

#ifdef GL_CCW
constexpr const enum_value<GLenum, mp_list<oglplus::face_orientation>>
  enum_values::ccw;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::clamp_color_target>>
  enum_values::clamp_read_color;
#endif

#ifdef GL_CLAMP_TO_BORDER
constexpr const enum_value<GLenum, mp_list<oglplus::texture_wrap_mode>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::clear_buffer;
#endif

#ifdef GL_CLEAR_TEXTURE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::clear_texture;
#endif
...
constexpr const enum_value<GLbitfield, mp_list<oglplus::buffer_storage_bits>>
  enum_values::client_storage_bit;
#endif

#ifdef GL_CLIP_DISTANCE0
constexpr const enum_value<GLenum, mp_list<oglplus::indexed_value_base>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::color_array;
#endif

#ifdef GL_COLOR_ARRAY_ADDRESS_NV
constexpr const enum_value<GLenum, mp_list<oglplus::unified_array_address_nv>>
...
constexpr const enum_value<GLbitfield, mp_list<oglplus::buffer_select_bits>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::color_components;
#endif

#ifdef GL_COLOR_ENCODING
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::color_encoding;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::blend_equation_advanced>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::texture_compare_mode>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::shader_parameter>>
  enum_values::compile_status;
#endif

#ifdef GL_COMPRESSED_R11_EAC
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_data_internal_format>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::shader_type>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::compute_texture;
#endif

#ifdef GL_COMPUTE_WORK_GROUP_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::compute_work_group_size;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::blend_function>>
...
constexpr const enum_value<GLbitfield, mp_list<oglplus::context_profile_bits>>
...
constexpr const enum_value<GLbitfield, mp_list<oglplus::context_flag_bits>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::error_code>>
  enum_values::context_lost;
#endif

#ifdef GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH
constexpr const enum_value<GLenum, mp_list<oglplus::context_release_behavior>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::path_fill_mode_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::debug_output_severity>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::debug_output_source>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::debug_output_type>>
...
#ifdef GL_DECR
constexpr const enum_value<GLenum, mp_list<oglplus::stencil_operation>>
  enum_values::decr;
#endif
...
#ifdef GL_DEPTH
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_buffer>>
  enum_values::depth;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::depth_renderable;
#endif

#ifdef GL_DEPTH_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::depth_scale;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::texture_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_target>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::buffer_usage>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::element_array_unified_nv;
#endif
...
#ifdef GL_EYE_LINEAR
constexpr const enum_value<GLenum, mp_list<oglplus::path_gen_mode_nv>>
  enum_values::eye_linear;
#endif

#ifdef GL_FALSE
constexpr const enum_value<GLboolean, mp_list<oglplus::true_false>>
  enum_values::false_;
#endif

#ifdef GL_FASTEST
constexpr const enum_value<GLenum, mp_list<oglplus::hint_option>>
  enum_values::fastest;
#endif

#ifdef GL_FILE_NAME_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_font_target_nv>>
  enum_values::file_name_nv;
#endif

#ifdef GL_FILL
constexpr const enum_value<GLenum, mp_list<oglplus::polygon_mode>>
  enum_values::fill;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::provoke_mode>>
  enum_values::first_vertex_convention;
#endif

#ifdef GL_FIXED
constexpr const enum_value<GLenum, mp_list<oglplus::data_type>>
  enum_values::fixed;
#endif

#ifdef GL_FLAT
constexpr const enum_value<GLenum, mp_list<oglplus::path_cap_style_nv>>
  enum_values::flat;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_data_type>>
...
constexpr const enum_value<GLbitfield, mp_list<oglplus::path_metric_query_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::tess_gen_primitive_spacing>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::framebuffer_blend;
#endif

#ifdef GL_FRAMEBUFFER_COMPLETE
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_status>>
  enum_values::framebuffer_complete;
#endif

#ifdef GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_parameter>>
  enum_values::framebuffer_default_fixed_sample_locations;
#endif

#ifdef GL_FRAMEBUFFER_DEFAULT_HEIGHT
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_parameter>>
  enum_values::framebuffer_default_height;
#endif

#ifdef GL_FRAMEBUFFER_DEFAULT_LAYERS
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_parameter>>
  enum_values::framebuffer_default_layers;
#endif

#ifdef GL_FRAMEBUFFER_DEFAULT_SAMPLES
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_parameter>>
  enum_values::framebuffer_default_samples;
#endif

#ifdef GL_FRAMEBUFFER_DEFAULT_WIDTH
constexpr const enum_value<GLenum, mp_list<oglplus::framebuffer_parameter>>
  enum_values::framebuffer_default_width;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::framebuffer_renderable;
#endif

#ifdef GL_FRAMEBUFFER_RENDERABLE_LAYERED
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::framebuffer_renderable_layered;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::support_level>>
  enum_values::full_support;
#endif

#ifdef GL_FUNC_ADD
constexpr const enum_value<GLenum, mp_list<oglplus::blend_equation>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::generate_mipmap;
#endif

#ifdef GL_GEOMETRY_INPUT_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::geometry_input_type;
#endif

#ifdef GL_GEOMETRY_OUTPUT_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::geometry_output_type;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::geometry_texture;
#endif

#ifdef GL_GEOMETRY_VERTICES_OUT
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::geometry_vertices_out;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::get_texture_image_format;
#endif

#ifdef GL_GET_TEXTURE_IMAGE_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::get_texture_image_type;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::green_scale;
#endif

#ifdef GL_GUILTY_CONTEXT_RESET
constexpr const enum_value<GLenum, mp_list<oglplus::graphics_reset_status>>
...
#ifdef GL_HIGH_FLOAT
constexpr const enum_value<GLenum, mp_list<oglplus::precision_type>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::image_compatibility_class>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::image_compatibility_class;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::image_pixel_format;
#endif

#ifdef GL_IMAGE_PIXEL_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::image_pixel_type;
#endif

#ifdef GL_IMAGE_TEXEL_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::image_texel_size;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::index_offset;
#endif

#ifdef GL_INDEX_SHIFT
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::index_shift;
#endif
...
#ifdef GL_INTENSITY
constexpr const enum_value<GLenum, mp_list<oglplus::path_color_format_nv>>
  enum_values::intensity;
#endif

#ifdef GL_INTERLEAVED_ATTRIBS
constexpr const enum_value<GLenum, mp_list<oglplus::transform_feedback_mode>>
  enum_values::interleaved_attribs;
#endif

#ifdef GL_INTERNALFORMAT_ALPHA_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_alpha_size;
#endif

#ifdef GL_INTERNALFORMAT_ALPHA_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_alpha_type;
#endif

#ifdef GL_INTERNALFORMAT_BLUE_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_blue_size;
#endif

#ifdef GL_INTERNALFORMAT_BLUE_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_blue_type;
#endif

#ifdef GL_INTERNALFORMAT_DEPTH_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_depth_size;
#endif

#ifdef GL_INTERNALFORMAT_DEPTH_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_depth_type;
#endif

#ifdef GL_INTERNALFORMAT_GREEN_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_green_size;
#endif

#ifdef GL_INTERNALFORMAT_GREEN_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_green_type;
#endif

#ifdef GL_INTERNALFORMAT_PREFERRED
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_preferred;
#endif

#ifdef GL_INTERNALFORMAT_RED_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_red_size;
#endif

#ifdef GL_INTERNALFORMAT_RED_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_red_type;
#endif

#ifdef GL_INTERNALFORMAT_SHARED_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_shared_size;
#endif

#ifdef GL_INTERNALFORMAT_STENCIL_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_stencil_size;
#endif

#ifdef GL_INTERNALFORMAT_STENCIL_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_stencil_type;
#endif

#ifdef GL_INTERNALFORMAT_SUPPORTED
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::internalformat_supported;
#endif
...
#ifdef GL_ISOLINES
constexpr const enum_value<GLenum, mp_list<oglplus::tess_gen_primitive_type>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::primitive_type>>
...
#ifdef GL_LINEAR
constexpr const enum_value<GLenum,
  mp_list<oglplus::texture_mag_filter,
    oglplus::blit_filter,
...
constexpr const enum_value<GLenum, mp_list<oglplus::texture_min_filter>>
...
#ifdef GL_LOWER_LEFT
constexpr const enum_value<GLenum, mp_list<oglplus::clip_origin>>
...
constexpr const enum_value<GLbitfield,
...
#ifdef GL_MAP_COLOR
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::map_color;
#endif

#ifdef GL_MAP_FLUSH_EXPLICIT_BIT
constexpr const enum_value<GLbitfield, mp_list<oglplus::buffer_map_access>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::limit_query>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::max_combined_dimensions;
#endif
...
#ifdef GL_MODELVIEW
constexpr const enum_value<GLenum, mp_list<oglplus::old_matrix_mode>>
  enum_values::modelview;
#endif

#ifdef GL_MOVE_TO_CONTINUES_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_dash_offset_reset_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::named_string_param>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::clip_depth_mode>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::sync_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::patch_parameter>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::path_parameter_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::path_format_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::point_parameter>>
...
#ifdef GL_POLYGON
constexpr const enum_value<GLenum, mp_list<oglplus::old_primitive_type>>
  enum_values::polygon;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_alpha_bias;
#endif

#ifdef GL_POST_COLOR_MATRIX_ALPHA_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_alpha_scale;
#endif

#ifdef GL_POST_COLOR_MATRIX_BLUE_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_blue_bias;
#endif

#ifdef GL_POST_COLOR_MATRIX_BLUE_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_blue_scale;
#endif

#ifdef GL_POST_COLOR_MATRIX_GREEN_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_green_bias;
#endif

#ifdef GL_POST_COLOR_MATRIX_GREEN_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_green_scale;
#endif

#ifdef GL_POST_COLOR_MATRIX_RED_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_red_bias;
#endif

#ifdef GL_POST_COLOR_MATRIX_RED_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_color_matrix_red_scale;
#endif

#ifdef GL_POST_CONVOLUTION_ALPHA_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_alpha_bias;
#endif

#ifdef GL_POST_CONVOLUTION_ALPHA_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_alpha_scale;
#endif

#ifdef GL_POST_CONVOLUTION_BLUE_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_blue_bias;
#endif

#ifdef GL_POST_CONVOLUTION_BLUE_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_blue_scale;
#endif

#ifdef GL_POST_CONVOLUTION_GREEN_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_green_bias;
#endif

#ifdef GL_POST_CONVOLUTION_GREEN_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_green_scale;
#endif

#ifdef GL_POST_CONVOLUTION_RED_BIAS
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_red_bias;
#endif

#ifdef GL_POST_CONVOLUTION_RED_SCALE
constexpr const enum_value<GLenum, mp_list<oglplus::pixel_transfer_parameter>>
  enum_values::post_convolution_red_scale;
#endif

#ifdef GL_PRIMARY_COLOR_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_color_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::program_binary_length;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::conditional_render_mode>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::query_parameter>>
...
#ifdef GL_READ_ONLY
constexpr const enum_value<GLenum, mp_list<oglplus::access_specifier>>
  enum_values::read_only;
#endif

#ifdef GL_READ_PIXELS
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::read_pixels;
#endif

#ifdef GL_READ_PIXELS_FORMAT
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::read_pixels_format;
#endif

#ifdef GL_READ_PIXELS_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::read_pixels_type;
#endif
...
#ifdef GL_RED
constexpr const enum_value<GLenum,
  mp_list<oglplus::texture_swizzle_mode,
    oglplus::pixel_data_format,
    oglplus::pixel_data_internal_format>>
  enum_values::red;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::renderbuffer_parameter>>
...
#ifdef GL_RENDERER
constexpr const enum_value<GLenum, mp_list<oglplus::string_query>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::secondary_color_array;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::shader_image_atomic;
#endif

#ifdef GL_SHADER_IMAGE_LOAD
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::shader_image_load;
#endif

#ifdef GL_SHADER_IMAGE_STORE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::shader_image_store;
#endif

#ifdef GL_SHADER_INCLUDE_ARB
constexpr const enum_value<GLenum, mp_list<oglplus::named_string_type>>
...
#ifdef GL_SIGNALED
constexpr const enum_value<GLenum, mp_list<oglplus::sync_status>>
  enum_values::signaled;
#endif

#ifdef GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::simultaneous_texture_and_depth_test;
#endif

#ifdef GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::simultaneous_texture_and_depth_write;
#endif

#ifdef GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::simultaneous_texture_and_stencil_test;
#endif

#ifdef GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::simultaneous_texture_and_stencil_write;
#endif

#ifdef GL_SKIP_MISSING_GLYPH_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_missing_glyph_nv>>
...
#ifdef GL_SRGB_READ
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::srgb_read;
#endif

#ifdef GL_SRGB_WRITE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::srgb_write;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::stencil_components;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::stencil_renderable;
#endif
...
#ifdef GL_SYNC_FENCE
constexpr const enum_value<GLenum, mp_list<oglplus::sync_type>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::tess_control_texture;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::tess_evaluation_texture;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_compressed;
#endif

#ifdef GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_compressed_block_height;
#endif

#ifdef GL_TEXTURE_COMPRESSED_BLOCK_SIZE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_compressed_block_size;
#endif

#ifdef GL_TEXTURE_COMPRESSED_BLOCK_WIDTH
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_compressed_block_width;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::texture_coord_array;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::texture_target>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_gather;
#endif

#ifdef GL_TEXTURE_GATHER_SHADOW
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_gather_shadow;
#endif

#ifdef GL_TEXTURE_IMAGE_FORMAT
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_image_format;
#endif

#ifdef GL_TEXTURE_IMAGE_TYPE
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::texture_image_type;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::transform_feedback_buffer_mode;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::transform_feedback_varying_max_length;
#endif

#ifdef GL_TRANSFORM_FEEDBACK_VARYINGS
constexpr const enum_value<GLenum, mp_list<oglplus::program_parameter>>
  enum_values::transform_feedback_varyings;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::uniform_buffer_unified_nv;
#endif
...
#ifdef GL_UTF16_NV
constexpr const enum_value<GLenum, mp_list<oglplus::path_text_encoding_nv>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::client_capability>>
  enum_values::vertex_attrib_array_unified_nv;
#endif
...
constexpr const enum_value<GLenum, mp_list<oglplus::view_compatibility_class>>
...
constexpr const enum_value<GLenum, mp_list<oglplus::internal_format_parameter>>
  enum_values::view_compatibility_class;
#endif
