...
#ifdef AL_BITS
constexpr const enum_value<ALenum, mp_list<oalplus::buffer_parameter>>
  enum_values::bits;
#endif
...
constexpr const enum_value<ALenum, mp_list<oalplus::distance_model>>
...
#ifdef AL_EXTENSIONS
constexpr const enum_value<ALenum, mp_list<oalplus::string_query>>
  enum_values::extensions;
#endif

#ifdef AL_FORMAT_MONO16
constexpr const enum_value<ALenum, mp_list<oalplus::data_format>>
...
#ifdef AL_INITIAL
constexpr const enum_value<ALenum, mp_list<oalplus::source_state>>
  enum_values::initial;
#endif

#ifdef AL_INVALID_ENUM
constexpr const enum_value<ALenum, mp_list<oalplus::al_error_code>>
...
#ifdef AL_STATIC
constexpr const enum_value<ALenum, mp_list<oalplus::source_type>>
  enum_values::static_;
#endif
