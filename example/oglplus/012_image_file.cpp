...
class image_program : public program {
public:
...
public:
    image_texture(string_view image_path) {
        ...
        gl.texture_wrap(GL.texture_2d, GL.texture_wrap_t, GL.repeat);
        gl.texture_image_2d(GL.texture_2d, texture_image_file(image_path));
    }
};
...
class image_file_example : public example {
private:
    image_texture tex;
    image_program prog;
    screen_shape screen;
