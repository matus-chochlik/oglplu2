/**
 *  @example eagine/message_bus/006_conn_setup.cpp
 *
...
public:
    ...
    fibonacci_server(connection_setup& conn_setup)
      : base(
          this,
...
public:
    ...
    fibonacci_client(connection_setup& conn_setup)
      : base(
          this,
...
int main() {
    ...
    msgbus::fibonacci_client client(conn_setup);
    ...
    for(span_size_t i = 0; i < thread_count; ++i) {
        workers.emplace_back(
          [server{msgbus::fibonacci_server(conn_setup)}]() mutable {
