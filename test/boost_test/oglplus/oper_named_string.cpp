...
OGLPLUS_MOCK_GLFUNC(
  NamedStringARB, void(GLenum, GLint, const GLchar*, GLint, const GLchar*))

OGLPLUS_MOCK_GLFUNC(DeleteNamedStringARB, void(GLint, const GLchar*))

OGLPLUS_MOCK_GLFUNC(IsNamedStringARB, GLboolean(GLint, const GLchar*))
