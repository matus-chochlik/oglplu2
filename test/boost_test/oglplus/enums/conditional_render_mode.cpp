//  File test/boost_test/oglplus/enums/conditional_render_mode.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_conditional_render_mode_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "QUERY_BY_REGION_NO_WAIT") == 0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "QUERY_BY_REGION_NO_WAIT_INVERTED") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "QUERY_BY_REGION_WAIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "QUERY_BY_REGION_WAIT_INVERTED") ==
      0);
#endif
    ...
    x = ev.query_no_wait;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "QUERY_NO_WAIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "QUERY_NO_WAIT_INVERTED") == 0);
#endif

#ifdef GL_QUERY_WAIT
    x = ev.query_wait;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "QUERY_WAIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "QUERY_WAIT_INVERTED") == 0);
#endif
}
...
BOOST_AUTO_TEST_CASE(enum_conditional_render_mode_range) {
...
#ifdef GL_QUERY_BY_REGION_NO_WAIT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            conditional_render_mode(GL_QUERY_BY_REGION_NO_WAIT)) != r.end());
    }
#endif
...
#ifdef GL_QUERY_BY_REGION_WAIT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            conditional_render_mode(GL_QUERY_BY_REGION_WAIT)) != r.end());
    }
#endif
...
#ifdef GL_QUERY_NO_WAIT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), conditional_render_mode(GL_QUERY_NO_WAIT)) !=
          r.end());
    }
#endif
...
#ifdef GL_QUERY_NO_WAIT_INVERTED
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            conditional_render_mode(GL_QUERY_NO_WAIT_INVERTED)) != r.end());
    }
#endif
...
#ifdef GL_QUERY_WAIT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), conditional_render_mode(GL_QUERY_WAIT)) !=
          r.end());
    }
#endif
...
#ifdef GL_QUERY_WAIT_INVERTED
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            conditional_render_mode(GL_QUERY_WAIT_INVERTED)) != r.end());
    }
#endif
