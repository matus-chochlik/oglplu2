//  File test/boost_test/oglplus/enums/program_resource_property.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_program_resource_property_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ACTIVE_VARIABLES") == 0);
#endif

#ifdef GL_ARRAY_SIZE
    x = ev.array_size;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "ARRAY_SIZE") == 0);
#endif

#ifdef GL_ARRAY_STRIDE
    x = ev.array_stride;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "ARRAY_STRIDE") == 0);
#endif
    ...
    x = ev.block_index;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BLOCK_INDEX") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_DATA_SIZE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "COMPATIBLE_SUBROUTINES") == 0);
#endif

#ifdef GL_IS_PER_PATCH
    x = ev.is_per_patch;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IS_PER_PATCH") == 0);
#endif

#ifdef GL_IS_ROW_MAJOR
    x = ev.is_row_major;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IS_ROW_MAJOR") == 0);
#endif

#ifdef GL_LOCATION
    x = ev.location;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "LOCATION") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "LOCATION_COMPONENT") == 0);
#endif

#ifdef GL_LOCATION_INDEX
    x = ev.location_index;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "LOCATION_INDEX") == 0);
#endif

#ifdef GL_MATRIX_STRIDE
    x = ev.matrix_stride;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "MATRIX_STRIDE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "NUM_ACTIVE_VARIABLES") == 0);
#endif
    ...
    x = ev.offset;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OFFSET") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TOP_LEVEL_ARRAY_SIZE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TOP_LEVEL_ARRAY_STRIDE") == 0);
#endif
