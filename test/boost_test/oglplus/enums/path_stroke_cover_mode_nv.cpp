//  File test/boost_test/oglplus/enums/path_stroke_cover_mode_nv.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_path_stroke_cover_mode_nv_range) {
...
#ifdef GL_BOUNDING_BOX_NV
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            path_stroke_cover_mode_nv(GL_BOUNDING_BOX_NV)) != r.end());
    }
#endif
...
#ifdef GL_CONVEX_HULL_NV
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), path_stroke_cover_mode_nv(GL_CONVEX_HULL_NV)) !=
          r.end());
    }
#endif
