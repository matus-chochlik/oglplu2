//  File test/boost_test/oglplus/enums/framebuffer_status.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_framebuffer_status_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "FRAMEBUFFER_COMPLETE") == 0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "FRAMEBUFFER_INCOMPLETE_ATTACHMENT") == 0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS") ==
      0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "FRAMEBUFFER_INCOMPLETE_MULTISAMPLE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "FRAMEBUFFER_UNDEFINED") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "FRAMEBUFFER_UNSUPPORTED") == 0);
#endif
}
...
BOOST_AUTO_TEST_CASE(enum_framebuffer_status_range) {
...
#ifdef GL_FRAMEBUFFER_COMPLETE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), framebuffer_status(GL_FRAMEBUFFER_COMPLETE)) !=
          r.end());
    }
#endif
...
#ifdef GL_FRAMEBUFFER_UNDEFINED
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), framebuffer_status(GL_FRAMEBUFFER_UNDEFINED)) !=
          r.end());
    }
#endif
...
#ifdef GL_FRAMEBUFFER_UNSUPPORTED
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            framebuffer_status(GL_FRAMEBUFFER_UNSUPPORTED)) != r.end());
    }
#endif
