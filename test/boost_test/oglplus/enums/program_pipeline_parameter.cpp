//  File test/boost_test/oglplus/enums/program_pipeline_parameter.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_program_pipeline_parameter_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "ACTIVE_PROGRAM") == 0);
#endif

#ifdef GL_FRAGMENT_SHADER
    x = ev.fragment_shader;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FRAGMENT_SHADER") == 0);
#endif

#ifdef GL_GEOMETRY_SHADER
    x = ev.geometry_shader;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "GEOMETRY_SHADER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TESS_CONTROL_SHADER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TESS_EVALUATION_SHADER") == 0);
#endif

#ifdef GL_VERTEX_SHADER
    x = ev.vertex_shader;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "VERTEX_SHADER") == 0);
#endif
}
