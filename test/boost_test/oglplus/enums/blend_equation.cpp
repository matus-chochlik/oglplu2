//  File test/boost_test/oglplus/enums/blend_equation.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_blend_equation_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FUNC_ADD") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "FUNC_REVERSE_SUBTRACT") == 0);
#endif

#ifdef GL_FUNC_SUBTRACT
    x = ev.func_subtract;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FUNC_SUBTRACT") == 0);
#endif

#ifdef GL_MAX
    x = ev.max;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "MAX") == 0);
#endif

#ifdef GL_MIN
    x = ev.min;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "MIN") == 0);
#endif
}
