//  File test/boost_test/oglplus/enums/sl_data_type.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_sl_data_type_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BOOL") == 0);
#endif

#ifdef GL_BOOL_VEC2
    x = ev.bool_vec2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BOOL_VEC2") == 0);
#endif

#ifdef GL_BOOL_VEC3
    x = ev.bool_vec3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BOOL_VEC3") == 0);
#endif

#ifdef GL_BOOL_VEC4
    x = ev.bool_vec4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BOOL_VEC4") == 0);
#endif

#ifdef GL_DOUBLE
    x = ev.double_;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE") == 0);
#endif

#ifdef GL_DOUBLE_MAT2
    x = ev.double_mat2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT2") == 0);
#endif

#ifdef GL_DOUBLE_MAT2x3
    x = ev.double_mat2x3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT2x3") == 0);
#endif

#ifdef GL_DOUBLE_MAT2x4
    x = ev.double_mat2x4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT2x4") == 0);
#endif

#ifdef GL_DOUBLE_MAT3
    x = ev.double_mat3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT3") == 0);
#endif

#ifdef GL_DOUBLE_MAT3x2
    x = ev.double_mat3x2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT3x2") == 0);
#endif

#ifdef GL_DOUBLE_MAT3x4
    x = ev.double_mat3x4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT3x4") == 0);
#endif

#ifdef GL_DOUBLE_MAT4
    x = ev.double_mat4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT4") == 0);
#endif

#ifdef GL_DOUBLE_MAT4x2
    x = ev.double_mat4x2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT4x2") == 0);
#endif

#ifdef GL_DOUBLE_MAT4x3
    x = ev.double_mat4x3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_MAT4x3") == 0);
#endif

#ifdef GL_DOUBLE_VEC2
    x = ev.double_vec2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_VEC2") == 0);
#endif

#ifdef GL_DOUBLE_VEC3
    x = ev.double_vec3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_VEC3") == 0);
#endif

#ifdef GL_DOUBLE_VEC4
    x = ev.double_vec4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "DOUBLE_VEC4") == 0);
#endif

#ifdef GL_FLOAT
    x = ev.float_;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT") == 0);
#endif

#ifdef GL_FLOAT_MAT2
    x = ev.float_mat2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT2") == 0);
#endif

#ifdef GL_FLOAT_MAT2x3
    x = ev.float_mat2x3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT2x3") == 0);
#endif

#ifdef GL_FLOAT_MAT2x4
    x = ev.float_mat2x4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT2x4") == 0);
#endif

#ifdef GL_FLOAT_MAT3
    x = ev.float_mat3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT3") == 0);
#endif

#ifdef GL_FLOAT_MAT3x2
    x = ev.float_mat3x2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT3x2") == 0);
#endif

#ifdef GL_FLOAT_MAT3x4
    x = ev.float_mat3x4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT3x4") == 0);
#endif

#ifdef GL_FLOAT_MAT4
    x = ev.float_mat4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT4") == 0);
#endif

#ifdef GL_FLOAT_MAT4x2
    x = ev.float_mat4x2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT4x2") == 0);
#endif

#ifdef GL_FLOAT_MAT4x3
    x = ev.float_mat4x3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_MAT4x3") == 0);
#endif

#ifdef GL_FLOAT_VEC2
    x = ev.float_vec2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_VEC2") == 0);
#endif

#ifdef GL_FLOAT_VEC3
    x = ev.float_vec3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_VEC3") == 0);
#endif

#ifdef GL_FLOAT_VEC4
    x = ev.float_vec4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FLOAT_VEC4") == 0);
#endif

#ifdef GL_IMAGE_1D
    x = ev.image_1d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_1D") == 0);
#endif

#ifdef GL_IMAGE_1D_ARRAY
    x = ev.image_1d_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_1D_ARRAY") == 0);
#endif

#ifdef GL_IMAGE_2D
    x = ev.image_2d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_2D") == 0);
#endif

#ifdef GL_IMAGE_2D_ARRAY
    x = ev.image_2d_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_2D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "IMAGE_2D_MULTISAMPLE") == 0);
#endif
    ...
    x = ev.image_2d_rect;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_2D_RECT") == 0);
#endif

#ifdef GL_IMAGE_3D
    x = ev.image_3d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_3D") == 0);
#endif

#ifdef GL_IMAGE_BUFFER
    x = ev.image_buffer;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_BUFFER") == 0);
#endif

#ifdef GL_IMAGE_CUBE
    x = ev.image_cube;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "IMAGE_CUBE") == 0);
#endif

#ifdef GL_INT
    x = ev.int_;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT") == 0);
#endif

#ifdef GL_INT_IMAGE_1D
    x = ev.int_image_1d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_IMAGE_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_IMAGE_1D_ARRAY") == 0);
#endif

#ifdef GL_INT_IMAGE_2D
    x = ev.int_image_2d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_IMAGE_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_IMAGE_2D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_IMAGE_2D_MULTISAMPLE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_IMAGE_2D_RECT") == 0);
#endif

#ifdef GL_INT_IMAGE_3D
    x = ev.int_image_3d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_IMAGE_3D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_IMAGE_BUFFER") == 0);
#endif

#ifdef GL_INT_IMAGE_CUBE
    x = ev.int_image_cube;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_IMAGE_CUBE") == 0);
#endif

#ifdef GL_INT_SAMPLER_1D
    x = ev.int_sampler_1d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_1D_ARRAY") == 0);
#endif

#ifdef GL_INT_SAMPLER_2D
    x = ev.int_sampler_2d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_2D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_2D_RECT") == 0);
#endif

#ifdef GL_INT_SAMPLER_3D
    x = ev.int_sampler_3d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_3D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_BUFFER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INT_SAMPLER_CUBE") == 0);
#endif
    ...
    x = ev.int_vec2;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_VEC2") == 0);
#endif

#ifdef GL_INT_VEC3
    x = ev.int_vec3;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_VEC3") == 0);
#endif

#ifdef GL_INT_VEC4
    x = ev.int_vec4;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INT_VEC4") == 0);
#endif
    ...
    x = ev.sampler_1d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_1D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_1D_ARRAY_SHADOW") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_1D_SHADOW") == 0);
#endif

#ifdef GL_SAMPLER_2D
    x = ev.sampler_2d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_ARRAY_SHADOW") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_MULTISAMPLE") == 0);
#endif
    ...
    x = ev.sampler_2d_rect;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_RECT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_RECT_SHADOW") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_2D_SHADOW") == 0);
#endif

#ifdef GL_SAMPLER_3D
    x = ev.sampler_3d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_3D") == 0);
#endif

#ifdef GL_SAMPLER_BUFFER
    x = ev.sampler_buffer;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_BUFFER") == 0);
#endif

#ifdef GL_SAMPLER_CUBE
    x = ev.sampler_cube;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER_CUBE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_CUBE_MAP_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SAMPLER_CUBE_SHADOW") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_IMAGE_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_IMAGE_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_IMAGE_3D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_IMAGE_BUFFER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_IMAGE_CUBE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_SAMPLER_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_SAMPLER_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_SAMPLER_3D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_SAMPLER_CUBE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_VEC2") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_VEC3") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNSIGNED_INT_VEC4") == 0);
#endif
}
