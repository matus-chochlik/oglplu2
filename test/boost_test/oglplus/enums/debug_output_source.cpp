//  File test/boost_test/oglplus/enums/debug_output_source.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_debug_output_source_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DEBUG_SOURCE_API") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DEBUG_SOURCE_APPLICATION") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DEBUG_SOURCE_OTHER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DEBUG_SOURCE_THIRD_PARTY") == 0);
#endif
