//  File test/boost_test/oglplus/enums/object_type.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_object_type_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BUFFER") == 0);
#endif

#ifdef GL_FRAMEBUFFER
    x = ev.framebuffer;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FRAMEBUFFER") == 0);
#endif
    ...
    x = ev.program;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "PROGRAM") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "PROGRAM_PIPELINE") == 0);
#endif

#ifdef GL_QUERY
    x = ev.query;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "QUERY") == 0);
#endif
    ...
    x = ev.sampler;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SAMPLER") == 0);
#endif

#ifdef GL_SHADER
    x = ev.shader;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "SHADER") == 0);
#endif

#ifdef GL_TEXTURE
    x = ev.texture;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE") == 0);
#endif
