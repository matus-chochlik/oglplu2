...
#ifdef GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		framebuffer_parameter(GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS)
	) != r.end());
}
#endif
...
#ifdef GL_FRAMEBUFFER_DEFAULT_HEIGHT
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		framebuffer_parameter(GL_FRAMEBUFFER_DEFAULT_HEIGHT)
	) != r.end());
}
#endif
...
#ifdef GL_FRAMEBUFFER_DEFAULT_LAYERS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		framebuffer_parameter(GL_FRAMEBUFFER_DEFAULT_LAYERS)
	) != r.end());
}
#endif
...
#ifdef GL_FRAMEBUFFER_DEFAULT_SAMPLES
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		framebuffer_parameter(GL_FRAMEBUFFER_DEFAULT_SAMPLES)
	) != r.end());
}
#endif
...
#ifdef GL_FRAMEBUFFER_DEFAULT_WIDTH
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		framebuffer_parameter(GL_FRAMEBUFFER_DEFAULT_WIDTH)
	) != r.end());
}
#endif
