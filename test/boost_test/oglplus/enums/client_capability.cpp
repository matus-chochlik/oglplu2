//  File test/boost_test/oglplus/enums/client_capability.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_client_capability_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "COLOR_ARRAY") == 0);
#endif

#ifdef GL_EDGE_FLAG_ARRAY
    x = ev.edge_flag_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "EDGE_FLAG_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ELEMENT_ARRAY_UNIFIED_NV") == 0);
#endif

#ifdef GL_FOG_COORD_ARRAY
    x = ev.fog_coord_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "FOG_COORD_ARRAY") == 0);
#endif

#ifdef GL_INDEX_ARRAY
    x = ev.index_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "INDEX_ARRAY") == 0);
#endif

#ifdef GL_NORMAL_ARRAY
    x = ev.normal_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "NORMAL_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SECONDARY_COLOR_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_COORD_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "UNIFORM_BUFFER_UNIFIED_NV") == 0);
#endif

#ifdef GL_VERTEX_ARRAY
    x = ev.vertex_array;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "VERTEX_ARRAY") == 0);
#endif
