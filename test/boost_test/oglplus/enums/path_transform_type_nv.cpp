//  File test/boost_test/oglplus/enums/path_transform_type_nv.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_path_transform_type_nv_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "AFFINE_2D_NV") == 0);
#endif

#ifdef GL_AFFINE_3D_NV
    x = ev.affine_3d_nv;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "AFFINE_3D_NV") == 0);
#endif
    ...
    x = ev.translate_2d_nv;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TRANSLATE_2D_NV") == 0);
#endif

#ifdef GL_TRANSLATE_3D_NV
    x = ev.translate_3d_nv;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TRANSLATE_3D_NV") == 0);
#endif

#ifdef GL_TRANSLATE_X_NV
    x = ev.translate_x_nv;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TRANSLATE_X_NV") == 0);
#endif

#ifdef GL_TRANSLATE_Y_NV
    x = ev.translate_y_nv;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TRANSLATE_Y_NV") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TRANSPOSE_AFFINE_2D_NV") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TRANSPOSE_AFFINE_3D_NV") == 0);
#endif
}
