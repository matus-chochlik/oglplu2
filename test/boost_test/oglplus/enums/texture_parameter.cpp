//  File test/boost_test/oglplus/enums/texture_parameter.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_texture_parameter_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DEPTH_STENCIL_TEXTURE_MODE") ==
      0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_BASE_LEVEL") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_BORDER_COLOR") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_COMPARE_FUNC") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_COMPARE_MODE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_IMMUTABLE_FORMAT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_IMMUTABLE_LEVELS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_LOD_BIAS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_MAG_FILTER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_MAX_LEVEL") == 0);
#endif

#ifdef GL_TEXTURE_MAX_LOD
    x = ev.texture_max_lod;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_MAX_LOD") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_MIN_FILTER") == 0);
#endif

#ifdef GL_TEXTURE_MIN_LOD
    x = ev.texture_min_lod;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_MIN_LOD") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_SWIZZLE_A") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_SWIZZLE_B") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_SWIZZLE_G") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_SWIZZLE_R") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_SWIZZLE_RGBA") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_VIEW_MIN_LAYER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_VIEW_MIN_LEVEL") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_VIEW_NUM_LAYERS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_VIEW_NUM_LEVELS") == 0);
#endif

#ifdef GL_TEXTURE_WRAP_R
    x = ev.texture_wrap_r;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_WRAP_R") == 0);
#endif

#ifdef GL_TEXTURE_WRAP_S
    x = ev.texture_wrap_s;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_WRAP_S") == 0);
#endif

#ifdef GL_TEXTURE_WRAP_T
    x = ev.texture_wrap_t;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_WRAP_T") == 0);
#endif
}
...
BOOST_AUTO_TEST_CASE(enum_texture_parameter_range) {
...
#ifdef GL_DEPTH_STENCIL_TEXTURE_MODE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_DEPTH_STENCIL_TEXTURE_MODE)) != r.end());
    }
#endif
...
#ifdef GL_IMAGE_FORMAT_COMPATIBILITY_TYPE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_IMAGE_FORMAT_COMPATIBILITY_TYPE)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_BASE_LEVEL
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_BASE_LEVEL)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_BORDER_COLOR
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_BORDER_COLOR)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_COMPARE_FUNC
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_COMPARE_FUNC)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_COMPARE_MODE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_COMPARE_MODE)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_IMMUTABLE_FORMAT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_TEXTURE_IMMUTABLE_FORMAT)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_IMMUTABLE_LEVELS
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_TEXTURE_IMMUTABLE_LEVELS)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_LOD_BIAS
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_LOD_BIAS)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_MAG_FILTER
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_MAG_FILTER)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_MAX_LEVEL
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_MAX_LEVEL)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_MAX_LOD
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_MAX_LOD)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_MIN_FILTER
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_MIN_FILTER)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_MIN_LOD
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_MIN_LOD)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_SWIZZLE_A
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_SWIZZLE_A)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_SWIZZLE_B
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_SWIZZLE_B)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_SWIZZLE_G
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_SWIZZLE_G)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_SWIZZLE_R
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_SWIZZLE_R)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_SWIZZLE_RGBA
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_SWIZZLE_RGBA)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_TARGET
    {
        ...
        auto r = enum_value_range<texture_parameter>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_parameter(GL_TEXTURE_TARGET)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_VIEW_MIN_LAYER
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_VIEW_MIN_LAYER)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_VIEW_MIN_LEVEL
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), texture_parameter(GL_TEXTURE_VIEW_MIN_LEVEL)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_VIEW_NUM_LAYERS
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_TEXTURE_VIEW_NUM_LAYERS)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_VIEW_NUM_LEVELS
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_parameter(GL_TEXTURE_VIEW_NUM_LEVELS)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_WRAP_R
    {
        ...
        auto r = enum_value_range<texture_parameter>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_parameter(GL_TEXTURE_WRAP_R)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_WRAP_S
    {
        ...
        auto r = enum_value_range<texture_parameter>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_parameter(GL_TEXTURE_WRAP_S)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_WRAP_T
    {
        ...
        auto r = enum_value_range<texture_parameter>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_parameter(GL_TEXTURE_WRAP_T)) !=
          r.end());
    }
#endif
