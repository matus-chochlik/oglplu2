...
#ifdef GL_CLEAR_BUFFER
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_CLEAR_BUFFER)
	) != r.end());
}
#endif
...
#ifdef GL_CLEAR_TEXTURE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_CLEAR_TEXTURE)
	) != r.end());
}
#endif
...
#ifdef GL_COLOR_ENCODING
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_COLOR_ENCODING)
	) != r.end());
}
#endif
...
#ifdef GL_COLOR_RENDERABLE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_COLOR_RENDERABLE)
	) != r.end());
}
#endif
...
#ifdef GL_COMPUTE_TEXTURE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_COMPUTE_TEXTURE)
	) != r.end());
}
#endif
...
#ifdef GL_DEPTH_RENDERABLE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_DEPTH_RENDERABLE)
	) != r.end());
}
#endif
...
#ifdef GL_FRAGMENT_TEXTURE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_FRAGMENT_TEXTURE)
	) != r.end());
}
#endif
...
#ifdef GL_GEOMETRY_TEXTURE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_GEOMETRY_TEXTURE)
	) != r.end());
}
#endif
...
#ifdef GL_IMAGE_PIXEL_TYPE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_IMAGE_PIXEL_TYPE)
	) != r.end());
}
#endif
...
#ifdef GL_IMAGE_TEXEL_SIZE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_IMAGE_TEXEL_SIZE)
	) != r.end());
}
#endif
...
#ifdef GL_MAX_DEPTH
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_MAX_DEPTH)
	) != r.end());
}
#endif
...
#ifdef GL_MAX_HEIGHT
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_MAX_HEIGHT)
	) != r.end());
}
#endif
...
#ifdef GL_MAX_LAYERS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_MAX_LAYERS)
	) != r.end());
}
#endif
...
#ifdef GL_MAX_WIDTH
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_MAX_WIDTH)
	) != r.end());
}
#endif
...
#ifdef GL_NUM_SAMPLE_COUNTS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_NUM_SAMPLE_COUNTS)
	) != r.end());
}
#endif
...
#ifdef GL_READ_PIXELS_TYPE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_READ_PIXELS_TYPE)
	) != r.end());
}
#endif
...
#ifdef GL_SAMPLES
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_SAMPLES)
	) != r.end());
}
#endif
...
#ifdef GL_SHADER_IMAGE_LOAD
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_SHADER_IMAGE_LOAD)
	) != r.end());
}
#endif
...
#ifdef GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE)
	) != r.end());
}
#endif
...
#ifdef GL_SRGB_READ
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_SRGB_READ)
	) != r.end());
}
#endif
...
#ifdef GL_SRGB_WRITE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_SRGB_WRITE)
	) != r.end());
}
#endif
...
#ifdef GL_TEXTURE_GATHER
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_TEXTURE_GATHER)
	) != r.end());
}
#endif
...
#ifdef GL_TEXTURE_SHADOW
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_TEXTURE_SHADOW)
	) != r.end());
}
#endif
...
#ifdef GL_TEXTURE_VIEW
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_TEXTURE_VIEW)
	) != r.end());
}
#endif
...
#ifdef GL_VERTEX_TEXTURE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		internal_format_parameter(GL_VERTEX_TEXTURE)
	) != r.end());
}
#endif
