//  File test/boost_test/oglplus/enums/program_interface.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_program_interface_names) {
    ...
    x = ev.buffer_variable;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BUFFER_VARIABLE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "COMPUTE_SUBROUTINE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "FRAGMENT_SUBROUTINE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "GEOMETRY_SUBROUTINE") == 0);
#endif
    ...
    x = ev.program_input;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "PROGRAM_INPUT") == 0);
#endif

#ifdef GL_PROGRAM_OUTPUT
    x = ev.program_output;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "PROGRAM_OUTPUT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SHADER_STORAGE_BLOCK") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TESS_CONTROL_SUBROUTINE") == 0);
#endif
    ...
    x = ev.uniform;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "UNIFORM") == 0);
#endif

#ifdef GL_UNIFORM_BLOCK
    x = ev.uniform_block;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "UNIFORM_BLOCK") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "VERTEX_SUBROUTINE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "VERTEX_SUBROUTINE_UNIFORM") == 0);
#endif
}
