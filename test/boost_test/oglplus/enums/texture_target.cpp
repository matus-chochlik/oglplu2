//  File test/boost_test/oglplus/enums/texture_target.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_texture_target_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_1D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_1D_ARRAY") == 0);
#endif

#ifdef GL_TEXTURE_2D
    x = ev.texture_2d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_2D") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_2D_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_2D_MULTISAMPLE") == 0);
#endif
    ...
    x = ev.texture_3d;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_3D") == 0);
#endif

#ifdef GL_TEXTURE_BUFFER
    x = ev.texture_buffer;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "TEXTURE_BUFFER") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_ARRAY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_NEGATIVE_X")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_NEGATIVE_Y")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_NEGATIVE_Z")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_POSITIVE_X")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_POSITIVE_Y")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_CUBE_MAP_POSITIVE_Z")
      == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "TEXTURE_RECTANGLE") == 0);
#endif
}
...
BOOST_AUTO_TEST_CASE(enum_texture_target_range) {
	...
	BOOST_CHECK(std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_1D))
		    != r.end());
    }
#endif
	...
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(
	  std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_1D_ARRAY))
	  != r.end());
    }
#endif
	...
	--count;
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_2D))
		    != r.end());
    }
#endif
	...
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(
	  std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_2D_ARRAY))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_2D_MULTISAMPLE))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_2D_MULTISAMPLE_ARRAY))
	  != r.end());
    }
#endif
	...
	--count;
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_3D))
		    != r.end());
    }
#endif
	...
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(
	  std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_BUFFER))
	  != r.end());
    }
#endif
	...
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(
	  std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_ARRAY))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_X))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_X))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_Y))
	  != r.end());
    }
#endif
	...
	BOOST_CHECK(
	  std::find(
	    r.begin(), r.end(), texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_Z))
	  != r.end());
    }
#endif
	...
	auto r = enum_value_range<texture_target>();
	BOOST_CHECK(
	  std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_RECTANGLE))
	  != r.end());
    }
#endif
