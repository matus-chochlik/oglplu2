...
BOOST_AUTO_TEST_CASE(enum_texture_target_range) {
...
#ifdef GL_TEXTURE_1D
    {
        ...
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_1D)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_2D
    {
        ...
        auto r = enum_value_range<texture_target>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_2D)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_2D_MULTISAMPLE_ARRAY
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_2D_MULTISAMPLE_ARRAY)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_3D
    {
        ...
        auto r = enum_value_range<texture_target>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), texture_target(GL_TEXTURE_3D)) !=
          r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_NEGATIVE_X
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_X)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_NEGATIVE_Y
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_NEGATIVE_Z
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_POSITIVE_X
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_X)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_POSITIVE_Y
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_Y)) != r.end());
    }
#endif
...
#ifdef GL_TEXTURE_CUBE_MAP_POSITIVE_Z
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            texture_target(GL_TEXTURE_CUBE_MAP_POSITIVE_Z)) != r.end());
    }
#endif
