//  File test/boost_test/oglplus/enums/texture_min_filter.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_texture_min_filter_names) {
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "LINEAR_MIPMAP_LINEAR") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "LINEAR_MIPMAP_NEAREST") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "NEAREST_MIPMAP_LINEAR") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "NEAREST_MIPMAP_NEAREST") == 0);
#endif
}
