//  File test/boost_test/oglplus/enums/buffer_parameter.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_buffer_parameter_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BUFFER_ACCESS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_ACCESS_FLAGS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_IMMUTABLE_STORAGE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_MAP_LENGTH") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_MAP_OFFSET") == 0);
#endif

#ifdef GL_BUFFER_MAPPED
    x = ev.buffer_mapped;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BUFFER_MAPPED") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "BUFFER_STORAGE_FLAGS") == 0);
#endif

#ifdef GL_BUFFER_USAGE
    x = ev.buffer_usage;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "BUFFER_USAGE") == 0);
#endif
}
