...
BOOST_AUTO_TEST_CASE(enum_buffer_storage_bits_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "CLIENT_STORAGE_BIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "DYNAMIC_STORAGE_BIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "SPARSE_STORAGE_BIT_ARB") == 0);
#endif
}
