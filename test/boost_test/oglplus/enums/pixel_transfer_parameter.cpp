...
#ifdef GL_ALPHA_BIAS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_ALPHA_BIAS)
	) != r.end());
}
#endif
...
#ifdef GL_ALPHA_SCALE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_ALPHA_SCALE)
	) != r.end());
}
#endif
...
#ifdef GL_BLUE_BIAS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_BLUE_BIAS)
	) != r.end());
}
#endif
...
#ifdef GL_BLUE_SCALE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_BLUE_SCALE)
	) != r.end());
}
#endif
...
#ifdef GL_DEPTH_BIAS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_DEPTH_BIAS)
	) != r.end());
}
#endif
...
#ifdef GL_DEPTH_SCALE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_DEPTH_SCALE)
	) != r.end());
}
#endif
...
#ifdef GL_GREEN_BIAS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_GREEN_BIAS)
	) != r.end());
}
#endif
...
#ifdef GL_GREEN_SCALE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_GREEN_SCALE)
	) != r.end());
}
#endif
...
#ifdef GL_INDEX_OFFSET
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_INDEX_OFFSET)
	) != r.end());
}
#endif
...
#ifdef GL_INDEX_SHIFT
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_INDEX_SHIFT)
	) != r.end());
}
#endif
...
#ifdef GL_MAP_COLOR
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_MAP_COLOR)
	) != r.end());
}
#endif
...
#ifdef GL_MAP_STENCIL
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_MAP_STENCIL)
	) != r.end());
}
#endif
...
#ifdef GL_RED_BIAS
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_RED_BIAS)
	) != r.end());
}
#endif
...
#ifdef GL_RED_SCALE
{
	...
	BOOST_CHECK(std::find(
		r.begin(), r.end(),
		pixel_transfer_parameter(GL_RED_SCALE)
	) != r.end());
}
#endif
