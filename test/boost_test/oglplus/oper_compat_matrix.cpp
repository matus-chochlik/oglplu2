...
#ifdef GL_EXT_direct_state_access
OGLPLUS_MOCK_GLFUNC(
  MatrixTranslatefEXT, void(GLenum, GLfloat, GLfloat, GLfloat))
#endif
...
#ifdef GL_EXT_direct_state_access
OGLPLUS_MOCK_GLFUNC(
  MatrixTranslatedEXT, void(GLenum, GLdouble, GLdouble, GLdouble))
#endif
#endif // GL_DOUBLE
...
#ifdef GL_EXT_direct_state_access
OGLPLUS_MOCK_GLFUNC(
  MatrixRotatefEXT, void(GLenum, GLfloat, GLfloat, GLfloat, GLfloat))
#endif
...
#ifdef GL_EXT_direct_state_access
OGLPLUS_MOCK_GLFUNC(
  MatrixRotatedEXT, void(GLenum, GLdouble, GLdouble, GLdouble, GLdouble))
#endif
#endif // GL_DOUBLE
...
OGLPLUS_MOCK_GLFUNC(
  Ortho, void(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble))
OGLPLUS_MOCK_GLFUNC(
