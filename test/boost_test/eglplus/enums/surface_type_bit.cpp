//  File test/boost_test/eglplus/enums/surface_type_bit.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_surface_type_bit_names) {
    ...
    x = ev.pbuffer_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "PBUFFER_BIT") == 0);
#endif

#ifdef EGL_PIXMAP_BIT
    x = ev.pixmap_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "PIXMAP_BIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "VG_ALPHA_FORMAT_PRE_BIT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "VG_COLORSPACE_LINEAR_BIT") == 0);
#endif

#ifdef EGL_WINDOW_BIT
    x = ev.window_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "WINDOW_BIT") == 0);
#endif
}
