//  File test/boost_test/eglplus/enums/renderable_type_bit.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_renderable_type_bit_names) {
    ...
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OPENGL_BIT") == 0);
#endif

#ifdef EGL_OPENGL_ES2_BIT
    x = ev.opengl_es2_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OPENGL_ES2_BIT") == 0);
#endif

#ifdef EGL_OPENGL_ES3_BIT
    x = ev.opengl_es3_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OPENGL_ES3_BIT") == 0);
#endif

#ifdef EGL_OPENGL_ES_BIT
    x = ev.opengl_es_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OPENGL_ES_BIT") == 0);
#endif

#ifdef EGL_OPENVG_BIT
    x = ev.openvg_bit;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "OPENVG_BIT") == 0);
#endif
}
