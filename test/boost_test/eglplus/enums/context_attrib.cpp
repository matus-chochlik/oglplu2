//  File test/boost_test/eglplus/enums/context_attrib.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_context_attrib_names) {
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "CONTEXT_MAJOR_VERSION") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "CONTEXT_MINOR_VERSION") == 0);
#endif
