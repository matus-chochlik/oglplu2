...
test_units_dimension_pow1_d_bd(void) {
    BOOST_CHECK_EQUAL(get_pow_of_dim(TestedBD(), Dimension()),
...
struct units_dimension_pow_tester {
	...
	test_units_dimension_pow1_d_bd<units::angle,
	  units::base::angle,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::solid_angle,
	  units::base::solid_angle,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::length,
	  units::base::length,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::mass,
	  units::base::mass,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::time,
	  units::base::time,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::temperature,
	  units::base::temperature,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::electric_current,
	  units::base::electric_current,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::number_of_cycles,
	  units::base::number_of_cycles,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::number_of_decays,
	  units::base::number_of_decays,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::luminous_intensity,
	  units::base::luminous_intensity,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::amount_of_substance,
	  units::base::amount_of_substance,
	  TestedBD>();
	test_units_dimension_pow1_d_bd<units::amount_of_information,
