...
struct mock_ptr {
    ...
    constexpr mock_ptr(std::nullptr_t)
      : _p(nullptr) {
    }
...
public:
    mock_function_base(const char* func_name, const std::tuple<P...>& params)
...
template <typename R, typename... P>
class mock_function<R(P...)> : public mock_function_base<R(P...)> {
private:
    R _result;
...
template <typename... P>
class mock_function<void(P...)> : public mock_function_base<void(P...)> {
public:
    mock_function(const char* func_name)
...
static inline mock_function_aoe_test<R(P...)>
...
static inline mock_function_aoe_test<void(P...)>
