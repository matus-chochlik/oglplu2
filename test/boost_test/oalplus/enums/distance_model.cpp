//  File test/boost_test/oalplus/enums/distance_model.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_distance_model_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "EXPONENT_DISTANCE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "EXPONENT_DISTANCE_CLAMPED") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INVERSE_DISTANCE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "INVERSE_DISTANCE_CLAMPED") == 0);
#endif

#ifdef AL_LINEAR_DISTANCE
    x = ev.linear_distance;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "LINEAR_DISTANCE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "LINEAR_DISTANCE_CLAMPED") == 0);
#endif
