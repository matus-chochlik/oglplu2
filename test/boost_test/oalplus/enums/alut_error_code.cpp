//  File test/boost_test/oalplus/enums/alut_error_code.cpp
//
...
BOOST_AUTO_TEST_CASE(enum_alut_error_code_names) {
    ...
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_AL_ERROR_ON_ENTRY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_ALC_ERROR_ON_ENTRY") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_BUFFER_DATA") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_CLOSE_DEVICE") == 0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "ERROR_CORRUPT_OR_TRUNCATED_DATA") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_CREATE_CONTEXT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_DESTROY_CONTEXT") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_GEN_BUFFERS") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_INVALID_ENUM") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_INVALID_OPERATION") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_INVALID_VALUE") == 0);
#endif

#ifdef ALUT_ERROR_IO_ERROR
    x = ev.error_io_error;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "ERROR_IO_ERROR") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_MAKE_CONTEXT_CURRENT") ==
      0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_NO_CURRENT_CONTEXT") == 0);
#endif

#ifdef ALUT_ERROR_NO_ERROR
    x = ev.error_no_error;
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(std::strcmp(enum_value_name(x).data(), "ERROR_NO_ERROR") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_OPEN_DEVICE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_OUT_OF_MEMORY") == 0);
#endif
    ...
    BOOST_CHECK(
      std::strcmp(
        enum_value_name(x).data(), "ERROR_UNSUPPORTED_FILE_SUBTYPE") == 0);
#endif
    ...
    BOOST_ASSERT(enum_value_name(x).data() != nullptr);
    BOOST_CHECK(
      std::strcmp(enum_value_name(x).data(), "ERROR_UNSUPPORTED_FILE_TYPE") ==
      0);
#endif
}
...
BOOST_AUTO_TEST_CASE(enum_alut_error_code_range) {
...
#ifdef ALUT_ERROR_AL_ERROR_ON_ENTRY
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_AL_ERROR_ON_ENTRY)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_ALC_ERROR_ON_ENTRY
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_ALC_ERROR_ON_ENTRY)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_BUFFER_DATA
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_BUFFER_DATA)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_CLOSE_DEVICE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_CLOSE_DEVICE)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_CORRUPT_OR_TRUNCATED_DATA
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_CORRUPT_OR_TRUNCATED_DATA)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_CREATE_CONTEXT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_CREATE_CONTEXT)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_DESTROY_CONTEXT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_DESTROY_CONTEXT)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_GEN_BUFFERS
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_GEN_BUFFERS)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_INVALID_ENUM
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_INVALID_ENUM)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_INVALID_OPERATION
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_INVALID_OPERATION)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_INVALID_VALUE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_INVALID_VALUE)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_IO_ERROR
    {
        ...
        auto r = enum_value_range<alut_error_code>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), alut_error_code(ALUT_ERROR_IO_ERROR)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_MAKE_CONTEXT_CURRENT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_MAKE_CONTEXT_CURRENT)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_NO_CURRENT_CONTEXT
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_NO_CURRENT_CONTEXT)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_NO_ERROR
    {
        ...
        auto r = enum_value_range<alut_error_code>();
        BOOST_CHECK(
          std::find(r.begin(), r.end(), alut_error_code(ALUT_ERROR_NO_ERROR)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_OPEN_DEVICE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_OPEN_DEVICE)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_OUT_OF_MEMORY
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(), r.end(), alut_error_code(ALUT_ERROR_OUT_OF_MEMORY)) !=
          r.end());
    }
#endif
...
#ifdef ALUT_ERROR_UNSUPPORTED_FILE_SUBTYPE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_UNSUPPORTED_FILE_SUBTYPE)) != r.end());
    }
#endif
...
#ifdef ALUT_ERROR_UNSUPPORTED_FILE_TYPE
    {
        ...
        BOOST_CHECK(
          std::find(
            r.begin(),
            r.end(),
            alut_error_code(ALUT_ERROR_UNSUPPORTED_FILE_TYPE)) != r.end());
    }
#endif
